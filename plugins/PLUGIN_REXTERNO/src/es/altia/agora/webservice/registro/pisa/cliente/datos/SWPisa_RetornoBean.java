...
public class SWPisa_RetornoBean  extends es.altia.agora.webservice.registro.pisa.cliente.datos.BaseBean  implements java.io.Serializable {
    private es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_AnotacionesBean[] anotaciones;

    private es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_DomiciliosBean[] domicilios;
    ...
    private es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_TercerosBean[] terceros;

    private es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_ViasBean[] vias;
    ...
    public SWPisa_RetornoBean(
           ...
           es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_AnotacionesBean[] anotaciones,
           es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_DomiciliosBean[] domicilios,
           java.lang.String ejercicio,
           java.lang.String fecha,
           java.lang.String numero,
           boolean resultado,
           es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_TercerosBean[] terceros,
           es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_ViasBean[] vias) {
        super(
            busquedaExactaAYU,
            ciBusquedaExactaAYU,
            error,
     ...
     * @return anotaciones
     */
    public es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_AnotacionesBean[] getAnotaciones() {
        return anotaciones;
    }
     ...
     * @param anotaciones
     */
    public void setAnotaciones(es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_AnotacionesBean[] anotaciones) {
        this.anotaciones = anotaciones;
    }
     ...
     * @return domicilios
     */
    public es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_DomiciliosBean[] getDomicilios() {
        return domicilios;
    }
     ...
     * @param domicilios
     */
    public void setDomicilios(es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_DomiciliosBean[] domicilios) {
        this.domicilios = domicilios;
    }
     ...
     * @return terceros
     */
    public es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_TercerosBean[] getTerceros() {
        return terceros;
    }
     ...
     * @param terceros
     */
    public void setTerceros(es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_TercerosBean[] terceros) {
        this.terceros = terceros;
    }
     ...
     * @return vias
     */
    public es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_ViasBean[] getVias() {
        return vias;
    }
     ...
     * @param vias
     */
    public void setVias(es.altia.agora.webservice.registro.pisa.cliente.datos.SWPisa_ViasBean[] vias) {
        this.vias = vias;
    }
