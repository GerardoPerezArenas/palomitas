...
CREATE TABLE "AUDITORIA_ACCESO_MODULOS" 
   ("ID" DECIMAL(20,0) NOT NULL IDENTITY, 	
	"ID_ORGANIZACION" DECIMAL(1,0), 
	"ID_USUARIO" DECIMAL(4,0) NOT NULL, 
	"ID_APLICACION" DECIMAL(3,0), 
	"FECHA_ACCESO" DATETIME2 NOT NULL
 );	
...
VALUES(16, 'g_confirmSalirApp', 1, '¿Desea cerrar la Aplicación y salir al Escritorio?', NULL, NULL);
