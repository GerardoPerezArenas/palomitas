...
public class TipoMetadatos  implements java.io.Serializable {
     ...
     * - EE99 - Otros. */
    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.documento_e.metadatos.TipoEstadoElaboracion estadoElaboracion;
     ...
     * /*Otros* /
     * - TD99 - Otros. */
    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.documento_e.metadatos.TipoDocumental tipoDocumental;
    ...
    public TipoMetadatos(
           ...
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.documento_e.metadatos.TipoEstadoElaboracion estadoElaboracion,
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.documento_e.metadatos.TipoDocumental tipoDocumental,
     ...
     * - EE99 - Otros.
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.documento_e.metadatos.TipoEstadoElaboracion getEstadoElaboracion() {
     ...
     * - EE99 - Otros.
     */
    public void setEstadoElaboracion(es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.documento_e.metadatos.TipoEstadoElaboracion estadoElaboracion) {
        this.estadoElaboracion = estadoElaboracion;
    }
     ...
     * - TD99 - Otros.
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.documento_e.metadatos.TipoDocumental getTipoDocumental() {
     ...
     * - TD99 - Otros.
     */
    public void setTipoDocumental(es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.documento_e.metadatos.TipoDocumental tipoDocumental) {
        this.tipoDocumental = tipoDocumental;
    }
