...
public class InsertDocument  implements java.io.Serializable {
    ...
    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.Document document;
    ...
    public InsertDocument(
           ...
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.Document document) {
    ...
    /**
     * Gets the authentication value for this InsertDocument.
     * 
    ...
    /**
     * Sets the authentication value for this InsertDocument.
     * 
    ...
    /**
     * Gets the requestId value for this InsertDocument.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this InsertDocument.
     * 
     * @param requestId
     */
    ...
    /**
     * Gets the document value for this InsertDocument.
     * 
     * @return document
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.Document getDocument() {
        return document;
    }


    /**
     * Sets the document value for this InsertDocument.
     * 
     * @param document
     */
    public void setDocument(es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.Document document) {
        this.document = document;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InsertDocument)) return false;
        InsertDocument other = (InsertDocument) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InsertDocument.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:juntadeandalucia:cice:pfirma:modify:request:v2.0", ">insertDocument"));
