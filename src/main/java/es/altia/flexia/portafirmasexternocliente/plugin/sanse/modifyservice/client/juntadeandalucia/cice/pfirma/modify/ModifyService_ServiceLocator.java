...
public class ModifyService_ServiceLocator extends org.apache.axis.client.Service implements es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.modify.ModifyService_Service {
    ...
    private java.lang.String ModifyServicePort_address = "https://portafirmas.redsara.es/pf/servicesv2/ModifyService";
    ...
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.modify.ModifyService_PortType getModifyServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.modify.ModifyService_PortType getModifyServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.modify.ModifyServiceSoapBindingStub _stub = new es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.modify.ModifyServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.modify.ModifyService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.modify.ModifyServiceSoapBindingStub _stub = new es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.modify.ModifyServiceSoapBindingStub(new java.net.URL(ModifyServicePort_address), this);
                _stub.setPortName(getModifyServicePortWSDDServiceName());
                return _stub;
            }
        }
