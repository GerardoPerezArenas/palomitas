...
public class TipoMetadatosAdicionales  implements java.io.Serializable {
    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.MetadatoAdicional metadatoAdicional;

    public TipoMetadatosAdicionales() {
    }

    public TipoMetadatosAdicionales(
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.MetadatoAdicional metadatoAdicional) {
     ...
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.MetadatoAdicional getMetadatoAdicional() {
        return metadatoAdicional;
    }
     ...
     */
    public void setMetadatoAdicional(es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.MetadatoAdicional metadatoAdicional) {
        this.metadatoAdicional = metadatoAdicional;
    }
