/**
 * QueryEnhancedUserJobAssociatedToUserResponse.java
 *
...
public class QueryEnhancedUserJobAssociatedToUserResponse  implements java.io.Serializable {
    ...
    public QueryEnhancedUserJobAssociatedToUserResponse() {
    }
    ...
    /**
     * Gets the enhancedUserJobAssociatedList value for this QueryEnhancedUserJobAssociatedToUserResponse.
     * 
    ...
    /**
     * Sets the enhancedUserJobAssociatedList value for this QueryEnhancedUserJobAssociatedToUserResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryEnhancedUserJobAssociatedToUserResponse)) return false;
        QueryEnhancedUserJobAssociatedToUserResponse other = (QueryEnhancedUserJobAssociatedToUserResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryEnhancedUserJobAssociatedToUserResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:juntadeandalucia:cice:pfirma:query:request:v2.0", ">queryEnhancedUserJobAssociatedToUserResponse"));
