...
public class EnhancedUserJobAssociated  implements java.io.Serializable {
    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.EnhancedUser enhancedUser;

    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.EnhancedJob enhancedJob;
    ...
    public EnhancedUserJobAssociated(
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.EnhancedUser enhancedUser,
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.EnhancedJob enhancedJob,
     ...
     * @return enhancedUser
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.EnhancedUser getEnhancedUser() {
        return enhancedUser;
    }
     ...
     * @param enhancedUser
     */
    public void setEnhancedUser(es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.EnhancedUser enhancedUser) {
        this.enhancedUser = enhancedUser;
    }
     ...
     * @return enhancedJob
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.EnhancedJob getEnhancedJob() {
        return enhancedJob;
    }
     ...
     * @param enhancedJob
     */
    public void setEnhancedJob(es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.EnhancedJob enhancedJob) {
        this.enhancedJob = enhancedJob;
    }
