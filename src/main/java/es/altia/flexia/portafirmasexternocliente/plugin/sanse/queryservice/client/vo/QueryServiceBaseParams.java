...
public class QueryServiceBaseParams {
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + (this.codOrganizacion != null ? this.codOrganizacion.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final QueryServiceBaseParams other = (QueryServiceBaseParams) obj;
    ...
    public String toString() {
        return "QueryServiceBaseParams{" + "endPoint=" + endPoint + ", username=" + username + ", password=" + password + ", codOrganizacion=" + codOrganizacion + '}';
    }
}
