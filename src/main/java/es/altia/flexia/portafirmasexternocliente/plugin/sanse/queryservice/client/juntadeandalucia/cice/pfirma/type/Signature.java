...
public class Signature  implements java.io.Serializable {
    ...
    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.SignFormat signFormat;
    ...
    public Signature(
           ...
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.SignFormat signFormat,
           byte[] content) {
     ...
     * @return signFormat
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.SignFormat getSignFormat() {
        return signFormat;
    }
     ...
     * @param signFormat
     */
    public void setSignFormat(es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.SignFormat signFormat) {
        this.signFormat = signFormat;
    }
