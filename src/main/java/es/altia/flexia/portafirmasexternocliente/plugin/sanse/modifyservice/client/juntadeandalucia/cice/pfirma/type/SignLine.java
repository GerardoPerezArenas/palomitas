...
public class SignLine  implements java.io.Serializable {
    ...
    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.SignLineType type;
    ...
    public SignLine(
           ...
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.SignLineType type) {
     ...
     * @return type
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.SignLineType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(es.altia.flexia.portafirmasexternocliente.plugin.sanse.modifyservice.client.juntadeandalucia.cice.pfirma.type.SignLineType type) {
        this.type = type;
    }
