...
public class EnhancedUser  implements java.io.Serializable {
    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.User user;

    private es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.EnhancedUserJobInfo enhancedUserJobInfo;

    public EnhancedUser() {
    }

    public EnhancedUser(
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.User user,
           es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.EnhancedUserJobInfo enhancedUserJobInfo) {
           this.user = user;
     ...
     * @return user
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.User user) {
        this.user = user;
    }
     ...
     */
    public es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.EnhancedUserJobInfo getEnhancedUserJobInfo() {
        return enhancedUserJobInfo;
    }
     ...
     */
    public void setEnhancedUserJobInfo(es.altia.flexia.portafirmasexternocliente.plugin.sanse.queryservice.client.juntadeandalucia.cice.pfirma.type.EnhancedUserJobInfo enhancedUserJobInfo) {
        this.enhancedUserJobInfo = enhancedUserJobInfo;
    }
