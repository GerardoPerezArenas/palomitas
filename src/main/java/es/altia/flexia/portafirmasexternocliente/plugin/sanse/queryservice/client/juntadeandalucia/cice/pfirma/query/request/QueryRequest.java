...
public class QueryRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the authentication value for this QueryRequest.
     * 
    ...
    /**
     * Sets the authentication value for this QueryRequest.
     * 
    ...
    /**
     * Gets the requestId value for this QueryRequest.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this QueryRequest.
     * 
     * @param requestId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:juntadeandalucia:cice:pfirma:query:request:v2.0", ">queryRequest"));
