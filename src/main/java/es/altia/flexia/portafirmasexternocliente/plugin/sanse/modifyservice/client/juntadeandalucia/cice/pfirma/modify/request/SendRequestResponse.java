...
public class SendRequestResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the requestId value for this SendRequestResponse.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this SendRequestResponse.
     * 
     * @param requestId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:juntadeandalucia:cice:pfirma:modify:request:v2.0", ">sendRequestResponse"));
