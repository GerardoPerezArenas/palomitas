...
public class SalidaFicheroDocumento  implements java.io.Serializable {
    ...
    private es.altia.flexiaWS.tramitacion.bd.datos.FicheroDocumentoVO resultado;
    ...
    public SalidaFicheroDocumento(
           ...
           es.altia.flexiaWS.tramitacion.bd.datos.FicheroDocumentoVO resultado) {
     ...
     * @return resultado
     */
    public es.altia.flexiaWS.tramitacion.bd.datos.FicheroDocumentoVO getResultado() {
        return resultado;
    }
     ...
     * @param resultado
     */
    public void setResultado(es.altia.flexiaWS.tramitacion.bd.datos.FicheroDocumentoVO resultado) {
        this.resultado = resultado;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://datos.bd.tramitacion.flexiaWS.altia.es", "SalidaFicheroDocumento"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://datos.bd.tramitacion.flexiaWS.altia.es", "FicheroDocumentoVO"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
