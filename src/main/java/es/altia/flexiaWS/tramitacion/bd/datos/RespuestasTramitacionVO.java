...
public class RespuestasTramitacionVO  implements java.io.Serializable {
    ...
    private es.altia.flexiaWS.tramitacion.bd.datos.TramiteVO[] tramitesIniciados;
    ...
    public RespuestasTramitacionVO(
           ...
           es.altia.flexiaWS.tramitacion.bd.datos.TramiteVO[] tramitesIniciados) {
     ...
     */
    public es.altia.flexiaWS.tramitacion.bd.datos.TramiteVO[] getTramitesIniciados() {
        return tramitesIniciados;
    }
     ...
     */
    public void setTramitesIniciados(es.altia.flexiaWS.tramitacion.bd.datos.TramiteVO[] tramitesIniciados) {
        this.tramitesIniciados = tramitesIniciados;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://datos.bd.tramitacion.flexiaWS.altia.es", "RespuestasTramitacionVO"));
