...
public class SalidaBoolean  implements java.io.Serializable {
    ...
    /**
     * Gets the codigoError value for this SalidaBoolean.
     * 
     * @return codigoError
     */
    ...
    /**
     * Sets the codigoError value for this SalidaBoolean.
     * 
     * @param codigoError
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://datos.bd.tramitacion.flexiaWS.altia.es", "SalidaBoolean"));
