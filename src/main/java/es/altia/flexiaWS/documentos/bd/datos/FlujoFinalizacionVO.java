...
public class FlujoFinalizacionVO  implements java.io.Serializable {
    private es.altia.flexiaWS.documentos.bd.datos.TramiteVO[] listaRespuesta;
    ...
    public FlujoFinalizacionVO(
           es.altia.flexiaWS.documentos.bd.datos.TramiteVO[] listaRespuesta,
           int tipoApertura) {
     ...
     */
    public es.altia.flexiaWS.documentos.bd.datos.TramiteVO[] getListaRespuesta() {
        return listaRespuesta;
    }
     ...
     */
    public void setListaRespuesta(es.altia.flexiaWS.documentos.bd.datos.TramiteVO[] listaRespuesta) {
        this.listaRespuesta = listaRespuesta;
    }
