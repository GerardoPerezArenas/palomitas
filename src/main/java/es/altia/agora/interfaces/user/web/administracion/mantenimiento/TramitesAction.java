 ...
 * <p>Descripción: Clase TramitesAction</p>
...
public class TramitesAction extends ActionSession  {
  ...
  public ActionForward performSession(ActionMapping mapping, ActionForm form,
    ...
    TramitesManager mantManager = TramitesManager.getInstance();
    if ("cargar".equalsIgnoreCase(opcion)){
      Vector lista = mantManager.getListaTramites(params);
      mantForm.setListaTramites(lista);
      ...
      lista = mantManager.eliminarTramite(identificador,codCampoAntiguo,codIdiomaAntiguo,params);
      mantForm.setListaTramites(lista);
      opcion = "vuelveCargar";
      ...
      Vector lista = mantManager.modificarTramite(gVO,params);
      mantForm.setListaTramites(lista);
      opcion = "vuelveCargar";
      ...
      gVO.setAtributo("codCampo",request.getParameter("codCampo"));
      gVO.setAtributo("idioma",request.getParameter("codIdioma"));
      Vector lista = mantManager.altaTramite(gVO,params);
      mantForm.setListaTramites(lista);
      opcion = "vuelveCargar";
