 ...
 * <p>Descripción: Clase AreasAction</p>
...
public class AreasAction extends ActionSession  {
  ...
  public ActionForward performSession(ActionMapping mapping, ActionForm form,
    ...
    AreasManager mantManager = AreasManager.getInstance();
    if ("cargar".equalsIgnoreCase(opcion)){
      Vector lista = mantManager.getListaAreas(params);
      mantForm.setListaAreas(lista);
      ...
      lista = mantManager.eliminarArea(identificador,codCampoAntiguo,codIdiomaAntiguo,params);
      if (lista.size()>0) {
          opcion = "vuelveCargar";
      mantForm.setListaAreas(lista);
      } else {
      ...
      Vector lista = mantManager.modificarArea(gVO,params);
      mantForm.setListaAreas(lista);
      opcion = "vuelveCargar";
      ...
      gVO.setAtributo("codCampo",request.getParameter("codCampo"));
      gVO.setAtributo("idioma",request.getParameter("codIdioma"));
      Vector lista = mantManager.altaArea(gVO,params);
      mantForm.setListaAreas(lista);
      opcion = "vuelveCargar";
