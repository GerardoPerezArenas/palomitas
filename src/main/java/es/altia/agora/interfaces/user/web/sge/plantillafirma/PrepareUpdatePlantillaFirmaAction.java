 ...
 */
public class PrepareUpdatePlantillaFirmaAction extends DefaultAction {
    /*_______Constants______________________________________________*/
    public static final String CLSNAME="PrepareUpdatePlantillaFirmaAction";
    ...
    protected ActionForward doPerform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, InternalErrorException, ModelException {
        ...
        if (request.getAttribute(Globals.ERROR_KEY) == null) {
            if (_log.isDebugEnabled()) _log.debug(CLSNAME+".doPerform() There are no previous errors... prefilling form");
            ...
            PlantillaFirmaPK pk = new PlantillaFirmaPK(concreteForm.getIdMunicipio(),
                    concreteForm.getIdProcedimiento(), concreteForm.getIdTramite(),
                    concreteForm.getIdPlantilla());
            PlantillaFirmaVO vo = facade.retrievePlantillaFirma(pk);
            ...
            if (_log.isDebugEnabled()) _log.debug(CLSNAME+".doPerform() There are errors... do not touch form");
        }//if
