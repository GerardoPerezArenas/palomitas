...
public class TiposAction extends ActionSession  {
  ...
  public ActionForward performSession(ActionMapping mapping, ActionForm form, 
    ...
    TiposManager mantManager = TiposManager.getInstance();
    GeneralValueObject gVO = recogerParametros(request);
    if ("cargar".equalsIgnoreCase(opcion)){
      Vector lista = mantManager.getListaTipos(params);
      mantForm.setListaTiposFormularios(lista);
    }else if("eliminar".equalsIgnoreCase(opcion)){
      String identificador = request.getParameter("identificador");
      Vector lista = new Vector();
      lista = mantManager.eliminarTipo(identificador,params);
      mantForm.setListaTiposFormularios(lista);
      opcion = "vuelveCargar";
    }else if("modificar".equals(opcion)){
      Vector lista = mantManager.modificarTipo(gVO,params);
      mantForm.setListaTiposFormularios(lista);
      opcion = "vuelveCargar";
    }else if("alta".equals(opcion)){
      Vector lista = mantManager.altaTipo(gVO,params);
      mantForm.setListaTiposFormularios(lista);
      opcion = "vuelveCargar";
