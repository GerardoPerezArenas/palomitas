/**
 * MantenimientosInformesForm.java
 *
...
public class MantenimientosInformesForm extends ActionForm {
	...
	// Para mantenimientos
	//
	private String codEstructuraInforme=null;
	
	private String COD_ENTIDADEINFORMEOculto = null;

	// Lista de campos de una entidad
	private String[] listaCampoInformeCodigo = null;
	private String[] listaCampoInformeNome = null;
	private String[] listaCampoInformeCampo = null;
	private String[] listaCampoInformeTipo = null;
	private String[] listaCampoInformeLonxitude = null;
	private String[] listaCampoInformeNomeas = null;

	// Lista de aplicaciones a los que está asignada una aplicación
	private String[] listaAplAplcod = null;

	// Lista de subentidades de la entidad que se está manteniendo
	private String[] listaSubentidadeCodigo = null;
	private String[] listaSubentidadeCampoJoinCampoEnt = null;
	private String[] listaSubentidadeCampoJoinCampoSubent = null;
	private String[] listaSubentidadeCampoJoinOuterJoin = null;
	...
	/**
	 * Returns the listaCampoInformeCampo.
	 * @return String[]
	 */
	public String[] getListaCampoInformeCampo() {
		return listaCampoInformeCampo;
	}

	/**
	 * Returns the listaCampoInformeLonxitude.
	 * @return String[]
	 */
	public String[] getListaCampoInformeLonxitude() {
		return listaCampoInformeLonxitude;
	}

	/**
	 * Returns the listaCampoInformeNome.
	 * @return String[]
	 */
	public String[] getListaCampoInformeNome() {
		return listaCampoInformeNome;
	}

	/**
	 * Returns the listaCampoInformeNomeas.
	 * @return String[]
	 */
	public String[] getListaCampoInformeNomeas() {
		return listaCampoInformeNomeas;
	}

	/**
	 * Returns the listaCampoInformeTipo.
	 * @return String[]
	 */
	public String[] getListaCampoInformeTipo() {
		return listaCampoInformeTipo;
	}

	/**
	 * Sets the listaCampoInformeCampo.
	 * @param listaCampoInformeCampo The listaCampoInformeCampo to set
	 */
	public void setListaCampoInformeCampo(String[] listaCampoInformeCampo) {
		this.listaCampoInformeCampo = listaCampoInformeCampo;
	}

	/**
	 * Sets the listaCampoInformeLonxitude.
	 * @param listaCampoInformeLonxitude The listaCampoInformeLonxitude to set
	 */
	public void setListaCampoInformeLonxitude(String[] listaCampoInformeLonxitude) {
		this.listaCampoInformeLonxitude = listaCampoInformeLonxitude;
	}

	/**
	 * Sets the listaCampoInformeNome.
	 * @param listaCampoInformeNome The listaCampoInformeNome to set
	 */
	public void setListaCampoInformeNome(String[] listaCampoInformeNome) {
		this.listaCampoInformeNome = listaCampoInformeNome;
	}

	/**
	 * Sets the listaCampoInformeNomeas.
	 * @param listaCampoInformeNomeas The listaCampoInformeNomeas to set
	 */
	public void setListaCampoInformeNomeas(String[] listaCampoInformeNomeas) {
		this.listaCampoInformeNomeas = listaCampoInformeNomeas;
	}

	/**
	 * Sets the listaCampoInformeTipo.
	 * @param listaCampoInformeTipo The listaCampoInformeTipo to set
	 */
	public void setListaCampoInformeTipo(String[] listaCampoInformeTipo) {
		this.listaCampoInformeTipo = listaCampoInformeTipo;
	}

	/**
	 * Returns the listaAplAplcod.
	 * @return String[]
	 */
	public String[] getListaAplAplcod() {
		return listaAplAplcod;
	}

	/**
	 * Sets the listaAplAplcod.
	 * @param listaAplAplcod The listaAplAplcod to set
	 */
	public void setListaAplAplcod(String[] listaAplAplcod) {
		this.listaAplAplcod = listaAplAplcod;
	}

	/**
	 * Returns the listaSubentidadeCodigo.
	 * @return String[]
	 */
	public String[] getListaSubentidadeCodigo() {
		return listaSubentidadeCodigo;
	}

	/**
	 * Sets the listaSubentidadeCodigo.
	 * @param listaSubentidadeCodigo The listaSubentidadeCodigo to set
	 */
	public void setListaSubentidadeCodigo(String[] listaSubentidadeCodigo) {
		this.listaSubentidadeCodigo = listaSubentidadeCodigo;
	}

	/**
	 * Returns the listaSubentidadeCampoJoinCampoEnt.
	 * @return String[]
	 */
	public String[] getListaSubentidadeCampoJoinCampoEnt() {
		return listaSubentidadeCampoJoinCampoEnt;
	}

	/**
	 * Returns the listaSubentidadeCampoJoinCampoSubent.
	 * @return String[]
	 */
	public String[] getListaSubentidadeCampoJoinCampoSubent() {
		return listaSubentidadeCampoJoinCampoSubent;
	}

	/**
	 * Returns the listaSubentidadeCampoJoinOuterJoin.
	 * @return String[]
	 */
	public String[] getListaSubentidadeCampoJoinOuterJoin() {
		return listaSubentidadeCampoJoinOuterJoin;
	}

	/**
	 * Sets the listaSubentidadeCampoJoinCampoEnt.
	 * @param listaSubentidadeCampoJoinCampoEnt The listaSubentidadeCampoJoinCampoEnt to set
	 */
	public void setListaSubentidadeCampoJoinCampoEnt(String[] listaSubentidadeCampoJoinCampoEnt) {
		this.listaSubentidadeCampoJoinCampoEnt =
			listaSubentidadeCampoJoinCampoEnt;
	}

	/**
	 * Sets the listaSubentidadeCampoJoinCampoSubent.
	 * @param listaSubentidadeCampoJoinCampoSubent The listaSubentidadeCampoJoinCampoSubent to set
	 */
	public void setListaSubentidadeCampoJoinCampoSubent(String[] listaSubentidadeCampoJoinCampoSubent) {
		this.listaSubentidadeCampoJoinCampoSubent =
			listaSubentidadeCampoJoinCampoSubent;
	}

	/**
	 * Sets the listaSubentidadeCampoJoinOuterJoin.
	 * @param listaSubentidadeCampoJoinOuterJoin The listaSubentidadeCampoJoinOuterJoin to set
	 */
	public void setListaSubentidadeCampoJoinOuterJoin(String[] listaSubentidadeCampoJoinOuterJoin) {
		this.listaSubentidadeCampoJoinOuterJoin =
			listaSubentidadeCampoJoinOuterJoin;
	}

	/**
	 * Returns the listaCampoInformeCodigo.
	 * @return String[]
	 */
	public String[] getListaCampoInformeCodigo() {
		return listaCampoInformeCodigo;
	}

	/**
	 * Sets the listaCampoInformeCodigo.
	 * @param listaCampoInformeCodigo The listaCampoInformeCodigo to set
	 */
	public void setListaCampoInformeCodigo(String[] listaCampoInformeCodigo) {
		this.listaCampoInformeCodigo = listaCampoInformeCodigo;
	}
	...
	/**
	 * Returns the cOD_ENTIDADEINFORMEOculto.
	 * @return String
	 */
	public String getCOD_ENTIDADEINFORMEOculto() {
		return COD_ENTIDADEINFORMEOculto;
	}

	/**
	 * Sets the cOD_ENTIDADEINFORMEOculto.
	 * @param cOD_ENTIDADEINFORMEOculto The cOD_ENTIDADEINFORMEOculto to set
	 */
	public void setCOD_ENTIDADEINFORMEOculto(String cOD_ENTIDADEINFORMEOculto) {
		COD_ENTIDADEINFORMEOculto = cOD_ENTIDADEINFORMEOculto;
	}

	/**
	 * @return
	 */
	public String getCodEstructuraInforme() {
		return codEstructuraInforme;
	}

	/**
	 * @param string
	 */
	public void setCodEstructuraInforme(String string) {
		codEstructuraInforme = string;
	}
