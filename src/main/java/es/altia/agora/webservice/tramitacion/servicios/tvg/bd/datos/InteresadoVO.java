...
public class InteresadoVO  implements java.io.Serializable {
    ...
    private es.altia.agora.webservice.tramitacion.servicios.tvg.bd.datos.DomicilioVO domicilio;
    ...
    public InteresadoVO(
           ...
           es.altia.agora.webservice.tramitacion.servicios.tvg.bd.datos.DomicilioVO domicilio,
     ...
     * @return domicilio
     */
    public es.altia.agora.webservice.tramitacion.servicios.tvg.bd.datos.DomicilioVO getDomicilio() {
        return domicilio;
    }
     ...
     * @param domicilio
     */
    public void setDomicilio(es.altia.agora.webservice.tramitacion.servicios.tvg.bd.datos.DomicilioVO domicilio) {
        this.domicilio = domicilio;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://datos.bd.tvg.servicios.tramitacion.webservice.agora.altia.es", "InteresadoVO"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://datos.bd.tvg.servicios.tramitacion.webservice.agora.altia.es", "DomicilioVO"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
