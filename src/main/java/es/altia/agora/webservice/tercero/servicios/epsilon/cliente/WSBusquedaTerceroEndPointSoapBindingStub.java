...
public class WSBusquedaTerceroEndPointSoapBindingStub extends org.apache.axis.client.Stub implements es.altia.agora.webservice.tercero.servicios.epsilon.cliente.WSBusquedaTerceroPort {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "domicilio"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://tercero.ws.altia.es", "DireccionWTO"), es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DireccionWTO.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://tercero.ws.altia.es", "ArrayOfDatosTerceroVO"));
        oper.setReturnClass(es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosTerceroVO[].class);
        ...
        oper.setReturnClass(es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosDomicilioVO[].class);
    ...
    public WSBusquedaTerceroEndPointSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            cls = es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosDomicilioVO[].class;
            ...
            cachedSerQNames.add(qName);
            cls = es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosTerceroVO[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosViaVO.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DireccionWTO.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {doi, tipoDocumento, nombre, apellido1, apellido2, domicilio});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosTerceroVO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosTerceroVO[]) org.apache.axis.utils.JavaUtils.convert(_resp, es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosTerceroVO[].class);
            }
        }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof es.altia.agora.webservice.tercero.servicios.epsilon.cliente.BusquedaTerceroWSException) {
              throw (es.altia.agora.webservice.tercero.servicios.epsilon.cliente.BusquedaTerceroWSException) axisFaultException.detail;
         }
   }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {idTercero, doi, tipoDocumento, nombre, apellido1, apellido2, domicilio});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosDomicilioVO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosDomicilioVO[]) org.apache.axis.utils.JavaUtils.convert(_resp, es.altia.agora.webservice.tercero.servicios.epsilon.cliente.DatosDomicilioVO[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
