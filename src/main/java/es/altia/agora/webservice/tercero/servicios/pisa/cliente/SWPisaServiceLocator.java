...
public class SWPisaServiceLocator extends org.apache.axis.client.Service implements es.altia.agora.webservice.tercero.servicios.pisa.cliente.SWPisaService {
    ...
    private java.lang.String Pisa_address = "http://net.sicalwin.com:9080/services/Pisa";
    ...
    public es.altia.agora.webservice.tercero.servicios.pisa.cliente.SWPisa getPisa(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.altia.agora.webservice.tercero.servicios.pisa.cliente.PisaSoapBindingStub _stub = new es.altia.agora.webservice.tercero.servicios.pisa.cliente.PisaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.altia.agora.webservice.tercero.servicios.pisa.cliente.SWPisa.class.isAssignableFrom(serviceEndpointInterface)) {
                es.altia.agora.webservice.tercero.servicios.pisa.cliente.PisaSoapBindingStub _stub = new es.altia.agora.webservice.tercero.servicios.pisa.cliente.PisaSoapBindingStub(new java.net.URL(Pisa_address), this);
                _stub.setPortName(getPisaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://net.sicalwin.com:9080/services/Pisa", "SWPisaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://net.sicalwin.com:9080/services/Pisa", "Pisa"));
        }
