...
public class WSBusquedaTerceroServiceLocator extends org.apache.axis.client.Service implements es.altia.agora.webservice.tercero.servicios.map.cliente.WSBusquedaTerceroService {
    ...
    private java.lang.String WSBusquedaTerceroEndPoint_address = "http://localhost:82/WSBusquedaTerceroMAP/services/WSBusquedaTerceroEndPoint";
    ...
    public es.altia.agora.webservice.tercero.servicios.map.cliente.WSBusquedaTerceroPort getWSBusquedaTerceroEndPoint() throws javax.xml.rpc.ServiceException {
    ...
    public es.altia.agora.webservice.tercero.servicios.map.cliente.WSBusquedaTerceroPort getWSBusquedaTerceroEndPoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.altia.agora.webservice.tercero.servicios.map.cliente.WSBusquedaTerceroEndPointSoapBindingStub _stub = new es.altia.agora.webservice.tercero.servicios.map.cliente.WSBusquedaTerceroEndPointSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.altia.agora.webservice.tercero.servicios.map.cliente.WSBusquedaTerceroPort.class.isAssignableFrom(serviceEndpointInterface)) {
                es.altia.agora.webservice.tercero.servicios.map.cliente.WSBusquedaTerceroEndPointSoapBindingStub _stub = new es.altia.agora.webservice.tercero.servicios.map.cliente.WSBusquedaTerceroEndPointSoapBindingStub(new java.net.URL(WSBusquedaTerceroEndPoint_address), this);
                _stub.setPortName(getWSBusquedaTerceroEndPointWSDDServiceName());
                return _stub;
            }
        }
