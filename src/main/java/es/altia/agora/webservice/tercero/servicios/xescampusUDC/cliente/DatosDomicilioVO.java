...
public class DatosDomicilioVO  implements java.io.Serializable {
    ...
    private es.altia.agora.webservice.tercero.servicios.xescampusUDC.cliente.DatosViaVO via;
    ...
    public DatosDomicilioVO(
           ...
           es.altia.agora.webservice.tercero.servicios.xescampusUDC.cliente.DatosViaVO via) {
           this.bloque = bloque;
     ...
     * @return via
     */
    public es.altia.agora.webservice.tercero.servicios.xescampusUDC.cliente.DatosViaVO getVia() {
        return via;
    }
     ...
     * @param via
     */
    public void setVia(es.altia.agora.webservice.tercero.servicios.xescampusUDC.cliente.DatosViaVO via) {
        this.via = via;
    }
