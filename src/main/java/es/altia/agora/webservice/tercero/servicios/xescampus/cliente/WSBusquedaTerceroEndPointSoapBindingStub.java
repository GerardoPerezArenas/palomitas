...
public class WSBusquedaTerceroEndPointSoapBindingStub extends org.apache.axis.client.Stub implements es.altia.agora.webservice.tercero.servicios.xescampus.cliente.WSBusquedaTerceroPort {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosTerceroVO[].class);
        ...
        oper.setReturnClass(es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosDomicilioVO[].class);
    ...
    public WSBusquedaTerceroEndPointSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            cls = es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosDomicilioVO[].class;
            ...
            cachedSerQNames.add(qName);
            cls = es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosTerceroVO[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosViaVO.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosTerceroVO[] findTercero(java.lang.String doi, java.lang.String tipoDocumento, java.lang.String nombre, java.lang.String apellido1, java.lang.String apellido2) throws java.rmi.RemoteException, es.altia.agora.webservice.tercero.servicios.xescampus.cliente.BusquedaTerceroWSException {
        if (super.cachedEndpoint == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {doi, tipoDocumento, nombre, apellido1, apellido2});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosTerceroVO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosTerceroVO[]) org.apache.axis.utils.JavaUtils.convert(_resp, es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosTerceroVO[].class);
            }
        }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof es.altia.agora.webservice.tercero.servicios.xescampus.cliente.BusquedaTerceroWSException) {
              throw (es.altia.agora.webservice.tercero.servicios.xescampus.cliente.BusquedaTerceroWSException) axisFaultException.detail;
         }
   }
  throw axisFaultException;
    ...
    public es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosDomicilioVO[] findDomicilio(java.lang.String idTercero, java.lang.String doi, java.lang.String tipoDocumento, java.lang.String nombre, java.lang.String apellido1, java.lang.String apellido2) throws java.rmi.RemoteException, es.altia.agora.webservice.tercero.servicios.xescampus.cliente.BusquedaTerceroWSException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {idTercero, doi, tipoDocumento, nombre, apellido1, apellido2});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosDomicilioVO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosDomicilioVO[]) org.apache.axis.utils.JavaUtils.convert(_resp, es.altia.agora.webservice.tercero.servicios.xescampus.cliente.DatosDomicilioVO[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
