...
public class DatosTerceroVO  implements java.io.Serializable {
    ...
    private es.altia.agora.webservice.tercero.servicios.map.cliente.DatosDomicilioVO[] domicilios;
    ...
    public DatosTerceroVO(
           ...
           es.altia.agora.webservice.tercero.servicios.map.cliente.DatosDomicilioVO[] domicilios,
     ...
     * @return domicilios
     */
    public es.altia.agora.webservice.tercero.servicios.map.cliente.DatosDomicilioVO[] getDomicilios() {
        return domicilios;
    }
     ...
     * @param domicilios
     */
    public void setDomicilios(es.altia.agora.webservice.tercero.servicios.map.cliente.DatosDomicilioVO[] domicilios) {
        this.domicilios = domicilios;
    }
