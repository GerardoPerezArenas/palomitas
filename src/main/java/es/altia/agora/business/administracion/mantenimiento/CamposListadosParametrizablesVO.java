...
public class CamposListadosParametrizablesVO implements Serializable, ValueObject {

    /** Construye un nuevo registroEntradaSalida por defecto. */
    public CamposListadosParametrizablesVO() {
        super();
    }
    ...
    public String getColumnaCampo() {
        return columnaCampo;
    }

    public void setColumnaCampo(String columnaCampo) {
        this.columnaCampo = columnaCampo;
    }
