...
public class PlainDocumentoRelacionFirmaFacadeDelegate implements DocumentoRelacionFirmaFacadeDelegate {
	...
	public PlainDocumentoRelacionFirmaFacadeDelegate() {
		try {
	...
	public List findDocumentoFirma(SearchCriteria selCriteria, OrderCriteria orderCriteria,  int startIndex, int count)
		throws InternalErrorException {
		return FacadeDelegateOperations.simpleFind(dsKey, DocumentoRelacionFirmaVO.class, selCriteria, orderCriteria, startIndex, count);
	}

    public List findDocumentoPortafirmas(SearchCriteria selCriteria, OrderCriteria orderCriteria, int startIndex, int count)
    throws InternalErrorException {

        return FacadeDelegateOperations.simpleFindCustom(dsKey, DocumentoRelacionFirmaVO.class, DocumentoRelacionPortafirmasVO.class, 
                selCriteria, orderCriteria, startIndex, count);
	...
	public long countDocumentoFirma(SearchCriteria selCriteria) throws InternalErrorException {        
        return FacadeDelegateOperations.simpleCount(dsKey, DocumentoRelacionFirmaVO.class, selCriteria);
	}
    ...
    public SearchCriteria scDocumentoFirmaByDocumento(DocumentoRelacionFirmaPK documentPK) throws InternalErrorException {
        CustomDocumentoRelacionFirmaDAO customDao = (CustomDocumentoRelacionFirmaDAO) FacadeDelegateOperations.getDAO(dsKey,DocumentoRelacionFirmaVO.class);
    ...
    public void firmarDocumentoPortafirmas(DocumentoRelacionFirmaVO vo) throws InstanceNotFoundException, InternalErrorException {
        try {
