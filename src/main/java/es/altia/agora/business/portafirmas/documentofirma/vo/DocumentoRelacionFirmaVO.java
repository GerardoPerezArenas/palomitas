...
public class DocumentoRelacionFirmaVO implements PersistentObject {
	...
	protected DocumentoRelacionFirmaPK pPrimaryKey;
    ...
    protected DocumentoRelacionFirmaVO() {}//constructor

	public DocumentoRelacionFirmaVO( DocumentoRelacionFirmaPK pk,  String theEstadoFirma,  byte[] theFirma,  Calendar theFechaFirma,  String theObservaciones ) {
        this(pk,theEstadoFirma,theFirma, theFechaFirma,  theObservaciones, null);
	}//constructor

    public DocumentoRelacionFirmaVO( int theIdMunicipio,  String theIdProcedimiento,  int theIdEjercicio,  String theIdNumeroExpediente,  int theIdTramite,  int theIdOcurrenciaTramite,  int theIdNumeroDocumento,  int theUsuarioFirmante ) {
        this(new DocumentoRelacionFirmaPK(theIdMunicipio,  theIdProcedimiento,
    ...
    public DocumentoRelacionFirmaVO( DocumentoRelacionFirmaPK pk,  String theEstadoFirma,  byte[] theFirma,  Calendar theFechaFirma,  String theObservaciones , Integer idUsuarioFirmante) {
        pPrimaryKey=pk;
