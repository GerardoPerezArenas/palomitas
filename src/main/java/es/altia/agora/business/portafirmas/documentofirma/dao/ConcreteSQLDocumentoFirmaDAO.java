...
/**
  ...
  * 
  **/
public class ConcreteSQLDocumentoFirmaDAO implements SQLDAO, 
						CustomDocumentoFirmaDAO,
	...
	private static final String MAIN_TABLE_NAME		= "E_CRD_FIR";
	private static final String[] VO_TABLES			= {"E_CRD_FIR"};
    ...
    private static final String SND_TABLE_NAME		= "E_CRD";
	...
	/* *********************************************************************** */
	public ConcreteSQLDocumentoFirmaDAO() {		
	}//constructor
	...
	public void initForDb(String dbKey) throws InternalErrorException {
		...
		retrieveCustomCmds.put(DocumentoFirmaVO.class.getName(), retrieveCmd);//{"DocumentoFirmaVO"->SQLDAORetrieveCmd}
		searchCustomCmds.put(DocumentoFirmaVO.class.getName(), searchCmd);//{"DocumentoFirmaVO"->SQLDAOSearchCmd}
        searchCustomCmds.put(DocumentoPortafirmasVO.class.getName(), documentoPortafirmasSearchCmd);//{"DocumentoPortafirmasVO"->SQLDAOSearchCmd}
	...
	public int pkBind(PrimaryKey primaryKey, PreparedStatement preparedStatement, int i) 
		throws SQLException {
		int result = i;
		final DocumentoFirmaPK concretePK = (DocumentoFirmaPK) primaryKey;
	...
	public int crBindAllNonPK(PersistentObject vo, PreparedStatement preparedStatement, int i) 
		throws SQLException {
		int result = i;
		final DocumentoFirmaVO concreteVO = (DocumentoFirmaVO) vo;
...
//		return new DocumentoFirmaVO((DocumentoFirmaPK) generatedKey,  concreteVO.getEstadoFirma(),  concreteVO.getFechaFirma(),  concreteVO.getObservaciones(), );
	...
	public void rtExtractVOFromResultSet(ResultSet resultSet, Map resultMap) 
		...
		/* Create VO. */
		final PersistentObject result = new DocumentoFirmaVO(new DocumentoFirmaPK( theIdMunicipio,  theIdProcedimiento,  theIdEjercicio,  theIdNumeroExpediente,  theIdTramite,  theIdOcurrenciaTramite,  theIdNumeroDocumento,  theUsuarioFirmante  ),  theEstadoFirma,  theFirma, theFechaFirma,  theObservaciones, theUsuarioDelegadoFirmante );
	...
	public int upBindUpdateFieldsToStatement(PersistentObject po, PreparedStatement preparedStatement, int i) 
		throws SQLException {
		int result = i;
		final DocumentoFirmaVO concreteVO = (DocumentoFirmaVO) po;
    ...
    private class DocumentoPortafirmasRetrieveAdapter implements SQLDAORetrieveCommandAdapter {
        ...
        public void rtExtractVOFromResultSet(ResultSet resultSet, Map resultMap) throws SQLException {
            ...
            /* Create VO. */
            final PersistentObject result = new DocumentoPortafirmasVO(
                    new DocumentoFirmaPK( theIdMunicipio,  theIdProcedimiento,
...
//		return createCmd.create(connection, newVO);
        ...
        DocumentoFirmaVO concreteVO = (DocumentoFirmaVO) newVO;
        ...
        if (usuarioFirmante==null)
            ...
            concreteVO = (DocumentoFirmaVO) createCmd.create(connection, concreteVO);
