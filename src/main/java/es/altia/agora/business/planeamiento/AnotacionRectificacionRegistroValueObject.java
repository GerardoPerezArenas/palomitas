...
public class AnotacionRectificacionRegistroValueObject implements Serializable {
    ...
    public AnotacionRectificacionRegistroValueObject() {
    }

    public AnotacionRectificacionRegistroValueObject(Character tipoRegistro, String codigoSubseccion,
