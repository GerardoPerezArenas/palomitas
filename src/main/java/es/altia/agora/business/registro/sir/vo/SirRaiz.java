...
public class SirRaiz {
    ...
    public SirRaiz(String codigo, String nombre_ES, String nombre_EU) {
        this.codigo = codigo;
    ...
    public String toString() {
        return "SirRaiz{" + "codigo=" + codigo + ", nombre_ES=" + nombre_ES + ", nombre_EU=" + nombre_EU + '}';
    }
