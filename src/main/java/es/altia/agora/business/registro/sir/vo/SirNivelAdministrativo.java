...
/**
 * BD: SIR_NIVEL_ADMINISTRATIVO
 * @author INGDGC
 */
public class SirNivelAdministrativo {
    ...
    public SirNivelAdministrativo(String codigo, String nombre_ES, String nombre_EU) {
        this.codigo = codigo;
    ...
    public String toString() {
        return "SirNivelAdministrativo{" + "codigo=" + codigo + ", nombre_ES=" + nombre_ES + ", nombre_EU=" + nombre_EU + '}';
    }
