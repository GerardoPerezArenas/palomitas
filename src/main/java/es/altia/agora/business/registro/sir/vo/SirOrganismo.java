 ...
 */
 public class SirOrganismo {
    ...
    public SirOrganismo(String codigo, String nombre_ES, String nombre_EU) {
         this.codigo = codigo;
    ...
    public String toString() {
        return "SirOrganismo{" + "codigo=" + codigo + ", nombre_ES=" + nombre_ES + ", nombre_EU=" + nombre_EU + '}';
    }
