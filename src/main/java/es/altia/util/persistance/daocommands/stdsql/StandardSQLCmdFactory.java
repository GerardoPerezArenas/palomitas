...
import es.altia.util.persistance.searchcriterias.stdsql.StdSearchCriteriaFactory;
 ...
 */
public class StandardSQLCmdFactory extends SQLDAOCommandFactory {
    public StandardSQLCmdFactory(){
        super();
    }

    public LimitCriteria newLimitCriteria() {
        throw new RuntimeException("StandardSQLCmdFactory: Not supported!");
    }//newLimitCriteria
    ...
    public SQLDAOBlobRetrieveCommand newBlobRetrieveCmd(SQLDAOBlobCommandAdapter adapter) {
        return new StdSQLDAOBlobRetrieveCmd(adapter);
    }

    public SQLDAOBlobStoreCommand newBlobStoreCmd(SQLDAOBlobCommandAdapter adapter) {
        return new StdSQLDAOBlobStoreCmd(adapter);
    }
    ...
    public SQLFormatter newSQLFormatter() {
        return StdSQLFormatter.getInstance();
    }//newSQLFormatter
    ...
    public SearchCriteriaFactory getSearchCriteriaFactory() {
        return StdSearchCriteriaFactory.getInstance();
