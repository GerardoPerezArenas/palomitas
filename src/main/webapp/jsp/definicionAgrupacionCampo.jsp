...
<html:html>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/css/font-awesome-4.6.2/less/animated.less'/>" media="screen" >
        ...
        <SCRIPT type="text/javascript">
            ...
            function validarOrdenAgrupacion(){
                var retorno = true;
                var orden = parseInt(document.getElementById("ordenAgrupacion").value);
                if(orden < 1){
                    retorno = false;
                }//if(orden < 1)
                return retorno
    ...
    <BODY class="bandaBody" onload="javascript:{ pleaseWait('off'); 
        ...
        <html:form action="/sge/DefinicionAgrupacionCampo" target="_self">
            ...
            <div style="width:100%" id="tabla1" class="txttitblanco"><%=descriptor.getDescripcion("tit_defCampo")%></div>
            <div class="contenidoPantalla">
                <table class="cuadroFondoBlanco" style="width: 100%">
                    <tr>
                        <td style="width:100%;  height:23px;" class="encabezadoGris"></td>
                    </tr>
                    <tr>
                        <td>
