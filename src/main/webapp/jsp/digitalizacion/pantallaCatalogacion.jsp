...
<html:html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/estiloie9.css"/>
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        <script type="text/javascript">
            ...
            function inicializar() {
                ...
                // Comprobamos si hay error en la operacion
                <c:set var='message' value='${requestScope.resultadoOp}' />
                <c:if test='${message != "0"}'>
                    mostrarError('<c:out value="${message}"/>');
                    return false;
                </c:if>
