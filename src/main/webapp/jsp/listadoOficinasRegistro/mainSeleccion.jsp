...
<body style="margin:0">
    ...
    <iframe src="<%=request.getContextPath() %>/jsp/listadoOficinasRegistro/seleccionUnidadRegistro.jsp" name="mainFrame" class="iframeMainFrame" noresize scrolling="NO" frameborder="0" marginwidth="0" marginheight="0"></iframe>
