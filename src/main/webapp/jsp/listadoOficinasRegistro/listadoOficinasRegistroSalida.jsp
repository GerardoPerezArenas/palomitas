...
<HTML>
    <head>
        <%            
            String tipo = "S"; // Sólo se trabaja con anotaciones de entrada
    ...
    function tratarMensajeError(){
        ...
        var codOficina = document.forms[0].codOficinaRegistroUsuario.value;
        var codUnidadRegistroUsuario = document.forms[0].codUnidadRegistroUsuario.value;
                        ...
                        <TD>
                            <TABLE width="100%" cellpadding="1" cellspacing="1">
                                ...
                                <TR>
                                    ...
                                    <TD style="width:5%" class="textoSuelto">
                                        <input type="radio" id="interopcion" name="interopcion" class="textoSuelto" style="padding-right: 20px" value="op1" onclick="" checked=true><%=descriptor.getDescripcion("etiq_interop1")%>
                                       <input type="radio" id="interopcion" name="interopcion" class="textoSuelto" style="padding-right: 20px" value="op2" onclick=""><%=descriptor.getDescripcion("etiq_interop2")%>
