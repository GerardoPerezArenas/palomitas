...
<head><jsp:include page="/jsp/sge/tpls/app-constants.jsp" />
       ...
       int numRelacionAsientosHistorico = relacionAsientosHistorico.size();
        ...
        if ( relacionAsientosHistorico != null ) {
         ...
         for (int i=ini; i< fin; i++ ) {
          ...
          String codRegistroTelematico = tram.getRegistroTelematico();
    %>
       var codRegTel ="<%=codRegistroTelematico%>";
    ...
    %>
      parent.mainFrame.document.forms[0].codRegistroTelematico.value = codRegTel;      
