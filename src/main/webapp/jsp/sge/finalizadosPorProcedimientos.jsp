...
<TITLE>::: EXPEDIENTES  Expedientes finalizados por procedimientos:::</TITLE>
...
function pulsarConsultar() {
  if( validarObligatorios('<%=descriptor.getDescripcion("msjObligTodos")%>')) {
    document.forms[0].opcion.value="consultarF";
...
<tr>
  <TD class="titulo" colspan="4"><%=descriptor.getDescripcion("tit_finalExpProc")%></TD>
</tr>
<TR>
  <TD>
    <TABLE width="100%" cellspacing="7px" cellpadding="1px" style="border-top: #7B9EC0 1px solid; border-bottom: #7B9EC0 1px solid;border-left: #7B9EC0 1px solid;border-right: #7B9EC0 1px solid;">
      ...
      <TR>
        <TD class="etiqueta" colspan="4" style="height:6px;background-color:#F7DAB0;" align="center"> <%=descriptor.getDescripcion("res_etiqListFinalP")%> </TD>
      </TR>
      <tr>
            ...
            <TR>
              <TD>
                <table width="100%" rules="cols" bordercolor="#7B9EC0" border="1" cellspacing="0" cellpadding="0" class="fondoCab">
                  <tr height="15">
                    <td width="25%" bgcolor="#7B9EC0" class="txtverdebold" align="center"><%= descriptor.getDescripcion("gEtiq_fecFinal")%></td>
                    <td width="25%" bgcolor="#7B9EC0" class="txtverdebold" align="center"><%= descriptor.getDescripcion("gEtiq_exped")%></td>
                    <td width="50%" bgcolor="#7B9EC0" class="txtverdebold" align="center"><%= descriptor.getDescripcion("gEtiq_solicit")%></td>
                  </tr>
                  <tr>
                    <td colspan="3">
    ...
    <TABLE class="tablaBotones" width="100%">
      <TR>
        <TD  width="50%" align="center">
          <input type= "button" class="boton" value=<%=descriptor.getDescripcion("gbConsultar")%> name="cmdConsultar" onclick="pulsarConsultar();">
        </TD>
        <TD width="50%" align="center">
