...
function redirecciona() {
    ...
    console.log('respOpcion: '+respOpcion);
    ...
    if ( ("noGrabado"==respOpcion) || ("grabado"==respOpcion) ){
        parent.grabacionTramite(respOpcion);
        parent.cargaDocumentos();
		    ...
		    //name = "T" + eds.getCodTramite() + eds.getCodCampo();
                   ...
                   if ("3".equalsIgnoreCase(eds.getCodTipoDato())) {
                     ...
                     if ((fechaVencimiento!= null)&&(!"".equals(fechaVencimiento))){
                          ...
                          //actualizamos el valor del icono alarma
                          if ((alarma!=null && alarma.equals("activada")) && (campoActivo!=null && campoActivo.equals("1"))) {%>                                          
                              parent.document.getElementById("imagenBoton"+'<%=name%>').style.color = "#6aaf23";
                              parent.document.getElementById("imagenBoton"+'<%=name%>').alt = "<%=descriptor.getDescripcion("etiqAlarma")%>";
                          <%}else {
                                if ((alarma!=null && alarma.equals("desactivada"))  && (campoActivo!=null && campoActivo.equals("1"))) {%>
                                     parent.document.getElementById("imagenBoton"+'<%=name%>').style.color = "#004595";
                                     parent.document.getElementById("imagenBoton"+'<%=name%>').alt = "<%=descriptor.getDescripcion("etiqAlarma")%>";
                                <%}
                           }
                       //cierre if fechaVencimiento   
                       }else{%>                                                            
                            parent.document.getElementById("imagenBoton"+'<%=name%>').className = "fa";
                            parent.document.getElementById("imagenBoton"+'<%=name%>').alt = "";
                      <%}
        ...
        if (errorGrabarDatosSuplFichero == "1")
            ...
            parent.finalizacionTramite(respOpcion, procedimientoAsociado);
        ...
        if ("finalizado"==respOpcion) {
            ...
            if(noPulsarVolver==null || noPulsarVolver!="SI")
                parent.pulsarVolver();            
                    ...
                    parent.finalizacionExpediente(respOpcion, procedimientoAsociado);
        ...
        if (tramites != null) {
          ...
          <%        }
                    ...
                    parent.tramiteIniciado(listaTramites,notifRealizada);
...
%>
            ...
            parent.tramitesPendientes(notifRealizada, resultadoFinalizar);
            } else {
                parent.tramitesPendientes(listaTramitesPendientes);
            }
            
        } else if ( ("tramitesSinFinalizar" == respOpcion) ) {
            parent.finalizarExpediente("<%=descriptor.getDescripcion("msjTramitesAbiertos")%>");
            ...
            parent.callbackCambioEstadoDocumento(respOpcion, respCodigoDocumento, respNuevoEstadoFirma);
            ...
            <% session.removeAttribute("resGrabarDocumento");%>
                        ...
                        if (listaDocumentos) listaDocumentos[cont] = ['<bean:write name="elemento" property="descDocumento" />',
                            ...
                            , parent.getEstadoFirmaVisual('<bean:write name="elemento" property="codDocumento" />',
                        ...
                        <% posicionDocumento++; %>
                            ...
                            parent.actualizaTabla(listaDocumentos,listaDocumentosOriginal);
        ...
        if (listaInteresados != null) {
          ...
          %>
            ...
            <% }
                    ...
                    parent.actualizaTablaInteresados(listaInteresados,listaInteresadosOriginal);
                    ...
                    cont = 0;
                    parent.listaFormsPDF = new Array();
                    parent.listaFormsPDFOriginal = new Array();
                    ...
                    // Comprobar que la colección del action no sea null.
                        ...
                        parent.listaFormsPDF[cont] = ['<bean:write name="elem" property="codigo" />',
                    ...
                    parent.listaFormsPDFOriginal[cont] = ['<bean:write name="elem" property="tipo" />',
                    ...
                    cont++;
                        ...
                        parent.tabFormsPDF.lineas=parent.listaFormsPDF;
                    parent.calcularPuedeAltaAdjunto();
                    parent.tabFormsPDF.displayTabla();
                    ...
                    if ("expedienteFinalizado" == resultadoFinalizar)
                        parent.pulsarVolverBuzonExpPendientes();
                    else
                        parent.pulsarVolver1();                        
...
function envioUnidadesTram() {
    ...
    if (unidadesTram.length == 0) {
        parent.enviarInfoExpIniciado(uorInicioExp, uorInicioExp);
	...
	'width=600,height=365,scrollbars=no,status='+ '<%=statusBar%>',function(uorInicioTram){
                        parent.enviarInfoExpIniciado(uorInicioExp, uorInicioTram);
                    });
    } else {
        parent.enviarInfoExpIniciado(uorInicioExp, unidadesTram[0][2]);
    }                    
}
