 ...
 <head><jsp:include page="/jsp/sge/tpls/app-constants.jsp" />
    ...
    <script>
      ...
      var frame = parent.mainFrame;
        ...
        %>
        frame.listaTabla = listaTabla;
        frame.listaInteresados = listaInteresados;
        frame.tablaInteresados.lineas = listaTabla;
        frame.tablaInteresados.displayTabla();
        frame.limpiarCamposRejilla();
    </script>
 </head>
 <body>
 </body>
