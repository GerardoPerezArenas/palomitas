...
<TITLE>::: EXPEDIENTES  Expedientes finalizados por solicitante :::</TITLE>
...
<tr>
  <TD class="titulo" colspan="2"><%=descriptor.getDescripcion("tit_finalExpSol")%></TD>
</tr>
...
<TABLE width="100%" cellspacing="4px" cellpadding="1px" style="border-top: #7B9EC0 1px solid; border-bottom: #7B9EC0 1px solid;border-left: #7B9EC0 1px solid;border-right: #7B9EC0 1px solid;">
  ...
  <TR>
    <TD class="etiqueta" colspan="2" style="height:6px;background-color:#F7DAB0;" align="center"> <%=descriptor.getDescripcion("res_etiqListFinalS")%> </TD>
  </TR>
  <tr>
          ...
          <TD>
            <table width="100%" rules="cols" bordercolor="#7B9EC0" border="1" cellspacing="0" cellpadding="0" class="fondoCab">
              <tr height="15">
                ...
                <td width="20%" bgcolor="#7B9EC0" class="txtverdebold" align="center"><%= descriptor.getDescripcion("gEtiq_fecIni")%></td>
                <td width="20%" bgcolor="#7B9EC0" class="txtverdebold" align="center"><%= descriptor.getDescripcion("gEtiq_fecFinal")%></td>
              </tr>
              <tr>
                <td colspan="5">
...
tab.addColumna('115','center');
tab.addColumna('145','center');
tab.addColumna('145','center');
