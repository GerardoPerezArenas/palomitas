...
function escribir(lista) {
  ...
  var exp = " <%=descriptor.getDescripcion("gEtiq_relacion")%> ";
  exp = exp.toUpperCase();
  htmlString += '<tr><td class="etiqueta" colspan="3">' + exp + ' REL_' +lista[0][0] + '</td></tr>';
...
<TABLE id ="tabla1" class="tablaBotones" width="90%" cellspacing="0" cellpadding="0">
<TR>
  <TD height="10px">&nbsp;</TD>
</TR>
<tr>
  <TD class="titulo" width="90%" colspan="2"><%=descriptor.getDescripcion("titInfTram")%></TD>
</tr>
<TR>
  <TD height="30px">&nbsp;</TD>
</TR>
...
<TR>
  <TD class="etiqueta" align="center" colspan="2" width="90%">
...
<TABLE class="tablaBotones" width="100%" border="0px">
  <TR>
    <TD  width="100%" align="center">
      <input type= "button" class="boton" accesskey="A" value="<%=descriptor.getDescripcion("gbAceptar")%>" name="cmdAceptar" onclick="pulsarAceptar();">
    </TD>
  </TR>
</TABLE>
