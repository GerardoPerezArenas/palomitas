...
function pulsarAceptar() {
  if(tab.selectedIndex != -1) {
    ...
    retorno = [datosOriginal[i][0],datosOriginal[i][2],datosOriginal[i][1],datosOriginal[i][3],datosOriginal[i][4]];
...
tab.addColumna('415','center','<%= descriptor.getDescripcion("gEtiq_nombre")%>');
