...
<%@ page import="es.altia.agora.interfaces.user.web.planeamiento.form.BienAndEspacioCatalogadoForm"%>
...
<TITLE>::: Bienes y Espacios Catalogados :::</TITLE>
<%
    ...
    Config m_Common = ConfigServiceHelper.getConfig("common");
    String CodigoSinTipoVia = m_Common.getString("T_TVI.CodigoSinTipoVia");
    String statusBar = m_Common.getString("JSP.StatusBar");
%>
...
function borrarDatos(){
    ...
    document.forms[0].denominacionBien.value = '';
    document.forms[0].codigoDomicilio.value = '';
    document.forms[0].domicilio.value = '';
    document.forms[0].codigoCatalogacion.value = '';
    document.forms[0].catalogacion.value = '';
    document.forms[0].codigoGradoProteccion.value = '';
    document.forms[0].gradoProteccion.value = '';
    document.forms[0].codigoRelacionBien.value = '';
    document.forms[0].relacionBien.value = '';
...
function pulsarLimpiar() {
    ...
    document.forms[0].action = "<html:rewrite page='/planeamiento/LimpiarBienAndEspacioCatalogado.do'/>" +
...
function Inicio() {
    ...
    <%
        ...
        if (numeroRegistro!=null) {
            ...
            String tipoRegistro = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getTipoRegistro();
            String anho = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getAnho();
            String numero = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getNumero();
            String denominacionBien = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getDenominacionBien();
            String codigoDomicilio = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getCodigoDomicilio();
            String codigoCatalogacion = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getCodigoCatalogacion();
            String codigoGradoProteccion = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getCodigoGradoProteccion();
            String codigoRelacionBien = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getCodigoRelacionBien();
            String fechaAprobacion = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getFechaAprobacion();
            String fechaBaja = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getFechaBaja();
            String fechaPublicacion = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getFechaPublicacion();
            String numeroPublicacion = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getNumeroPublicacion();
            if (numeroPublicacion==null) {
                numeroPublicacion = "";
            }
            String observaciones = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getObservaciones();
            if (observaciones==null) {
                observaciones = "";
            }
            String file = ((BienAndEspacioCatalogadoForm) session.getAttribute("BienAndEspacioCatalogadoForm")).getArchivo();
            if (file==null) {
                file = "";
            }
    ...
    %>
        ...
        var domCompleto = domicilioCompleto("<%=gVO.getAtributo("codTipoVia")%>",
        ...
        var denominacionBien = "<%=denominacionBien%>";
        ...
        rellenaDatosRegistro("<%=anho%>", "<%=numero%>", denominacionBien, "<%=codigoDomicilio%>", domCompleto, "<%=codigoCatalogacion%>",
                "<%=codigoGradoProteccion%>", "<%=codigoRelacionBien%>", "<%=fechaAprobacion%>",
                "<%=fechaBaja%>", "<%=fechaPublicacion%>", "<%=numeroPublicacion%>", observaciones, file, lista, listaRectificacion);
        numeroRegistro = "<%=numeroRegistro%>";
...
function pulsarModificar() {
    ...
    document.forms[0].denominacionBien.className = "textareaTextoObligatorio";
    document.forms[0].domicilio.className = "inputTextoObligatorio";
    document.getElementById("domicilioImg").style.display = "none";
    document.getElementById("domicilioImgGrabar").style.display = "inline";
    document.forms[0].codigoCatalogacion.className = "inputTextoObligatorio";
    document.forms[0].catalogacion.className = "inputTextoObligatorio";
    document.forms[0].codigoGradoProteccion.className = "inputTextoObligatorio";
    document.forms[0].gradoProteccion.className = "inputTextoObligatorio";
    document.forms[0].codigoRelacionBien.className = "inputTextoObligatorio";
    document.forms[0].relacionBien.className = "inputTextoObligatorio";
...
function pulsarGrabar() {
    if (validarFormulario()) {
        if (insertar) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/InsertarBienAndEspacioCatalogado.do'/>";
            document.forms[0].submit();
            insertar = false;
        }
        if (modificar || baja) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/ModificarBienAndEspacioCatalogado.do'/>";
            document.forms[0].submit();
            modificar = false;
            if (baja) {
                //                document.getElementById("trFechaBaja").style.display = "none";
        ...
        document.forms[0].fechaBaja.className = "inputTxtFecha";
        document.getElementById("domicilioImg").style.display = "inline";
        document.getElementById("domicilioImgGrabar").style.display = "none";
    }
}
...
function pulsarCancelar() {
    ...
    document.forms[0].anho.className = "inputTexto";
    document.forms[0].numero.className = "inputTexto";
    document.forms[0].denominacionBien.className = "textareaTexto";
    document.forms[0].domicilio.className = "inputTexto";
    document.getElementById("domicilioImg").style.display = "inline";
    document.getElementById("domicilioImgGrabar").style.display = "none";
    document.forms[0].codigoCatalogacion.className = "inputTexto";
    document.forms[0].catalogacion.className = "inputTexto";
    document.forms[0].codigoGradoProteccion.className = "inputTexto";
    document.forms[0].gradoProteccion.className = "inputTexto";
    document.forms[0].codigoRelacionBien.className = "inputTexto";
    document.forms[0].relacionBien.className = "inputTexto";
...
<%--function pulsarCancelarSalir() {
    window.location = "<html:rewrite page='/planeamiento/CargarBienAndEspacioCatalogado.do'/>?tipoRegistro=" + document.forms[0].tipoRegistro.value + "&consultando=true";
}--%>
...
//    habilitarCampos();
    var action = "<html:rewrite page='/planeamiento/BuscarBienAndEspacioCatalogado.do'/>";
...
function pulsarGrabarAnotacion() {
    if (document.forms[0].fechaAnotacion.value!="") {
        document.forms[0].target = "oculto";
        document.forms[0].action = "<html:rewrite page='/planeamiento/InsertarAnotacionBien.do'/>";
        document.forms[0].submit();
        pulsarCancelarAnotacion();
    } else {
...
function pulsarEliminarAnotacion() {
    if(tabAnotacion.selectedIndex != -1) {
        document.forms[0].target = "oculto";
        document.forms[0].action = "<html:rewrite page='/planeamiento/EliminarAnotacionBien.do'/>";
        document.forms[0].submit();
        pulsarCancelarAnotacion();
    } else {
...
function pulsarGrabarRectificacion() {
    if (document.forms[0].fechaRectificacion.value!="") {
        document.forms[0].target = "oculto";
        document.forms[0].action = "<html:rewrite page='/planeamiento/InsertarRectificacionBien.do'/>";
        document.forms[0].submit();
        pulsarCancelarRectificacion();
    } else {
        jsp_alerta("A", "Debe rellenar el campo obligatorio");
...
function pulsarEliminarRectificacion() {
    if(tabRectificacion.selectedIndex != -1) {
        document.forms[0].target = "oculto";
        document.forms[0].action = "<html:rewrite page='/planeamiento/EliminarRectificacionBien.do'/>";
        document.forms[0].submit();
        pulsarCancelarRectificacion();
    } else {
        jsp_alerta('A', '<%=descriptor.getDescripcion("msjNoSelecFila")%>');
...
function pulsarListado() {
    var action = "<html:rewrite page='/planeamiento/VerListadoBienAndEspacioCatalogado.do'/>";
    document.forms[0].target="mainFrame";
    document.forms[0].action = action;
    document.forms[0].submit();
}
...
function pulsarSalir(){
    window.location = "<html:rewrite page='/planeamiento/SalirBienAndEspacioCatalogado.do'/>";
}

function abrirDomicilios(opcion) {
  var argumentos = new Array();
  var source = "<html:rewrite page='/planeamiento/AbrirDomicilios.do'/>";
  var domicilio = "&codigoDomicilio=" + document.forms[0].codigoDomicilio.value;
  var opcionElegida = "&modoInicio=" + opcion;
  abrirXanelaAuxiliar('<%=request.getContextPath()%>/jsp/planeamiento/mainVentana.jsp?source='+source+domicilio+opcionElegida,argumentos,
	'width=700,height=330,status='+ '<%=statusBar%>',function(datos){
                        if(datos!=undefined){
                          document.forms[0].domicilio.value = datos[0];
                          document.forms[0].codigoDomicilio.value = datos[1];
                        }
                    });
}
...
function domicilioCompleto(codTVia, descTVia, descVia, txtNumDesde, txtLetraDesde, txtNumHasta, txtLetraHasta, txtBloque, txtPortal,
        txtEsc, txtPlta, txtPta, txtDomicilio, descESI, codECO, descECO, txtRefCatastral){
    var domCompleto="";
    if (descVia!=''){
        if (codTVia != '<%=CodigoSinTipoVia%>'){
            domCompleto += descTVia + " ";
        }
        domCompleto += descVia;
    }
    domCompleto += separadorComaDomicilio(domCompleto);
    domCompleto += ( txtNumDesde !='')?(' '+txtNumDesde ):'';
    domCompleto += ( txtLetraDesde !='')?(' '+txtLetraDesde):'';
    domCompleto += ( txtNumHasta !='')?('-'+txtNumHasta):'';
    domCompleto += ( txtLetraHasta !='')?(' '+txtLetraHasta):'';
    domCompleto += ( txtBloque !='')?(' Blq. '+txtBloque):'';
    domCompleto += ( txtPortal !='')?(' Port. '+txtPortal):'';
    domCompleto += ( txtEsc !='')?(' Esc. '+txtEsc):'';
    domCompleto += ( txtPlta !='')?(' Plta. '+txtPlta):'';
    domCompleto += ( txtPta !='')?(' Pta. '+txtPta):'';
    domCompleto += separadorComaDomicilio(domCompleto);
    if (txtDomicilio!=''){
        domCompleto += txtDomicilio;
    }
    domCompleto += separadorComaDomicilio(domCompleto);
    domCompleto +=  descESI;
    if (!eval(codECO==0) && !eval(codECO=="")){
        domCompleto += separadorComaDomicilio(domCompleto);
        domCompleto += descECO;
    }
    if(Trim(txtRefCatastral) != ''){
        domCompleto += separadorComaDomicilio(domCompleto);
        domCompleto += Trim(txtRefCatastral);
    }
    return domCompleto;
}
...
//    habilitarCampos();
    ...
    document.forms[0].target = "oculto";
    document.forms[0].action = "<html:rewrite page='/planeamiento/RellenarBienAndEspacioCatalogado.do'/>" +
                               "?numeroRegistro=" + numRegistro;
    document.forms[0].submit();
}
...
function rellenaDatosRegistro(anho,numero,denomBien,codDomicilio,descDomicilio,codCatalogacion,codGrado,codRelacion,
                              aprobacion,baja,fecPubli,numPubli,obs,arch, anotaciones,rectificaciones) {
    document.forms[0].anho.value = anho;
    document.forms[0].numero.value = numero;
    document.forms[0].denominacionBien.value = denomBien;
    document.forms[0].codigoDomicilio.value = codDomicilio;
    document.forms[0].domicilio.value = descDomicilio;
    document.forms[0].codigoCatalogacion.value = codCatalogacion;
    comboCatalogaciones.buscaLinea(codCatalogacion);
    document.forms[0].codigoGradoProteccion.value = codGrado;
    comboGradosProteccion.buscaLinea(codGrado);
    document.forms[0].codigoRelacionBien.value = codRelacion;
    comboRelacionesBien.buscaLinea(codRelacion);
...
function deshabilitarCampos() {
    ...
    document.forms[0].denominacionBien.disabled = true;
    document.forms[0].denominacionBien.className = "textareaTextoDeshabilitado";
    document.forms[0].domicilio.disabled = true;
    document.forms[0].domicilio.className = "textareaTextoDeshabilitado";
    comboCatalogaciones.deactivate();
    comboGradosProteccion.deactivate();
    comboRelacionesBien.deactivate();
...
function habilitarCampos() {
    ...
    document.forms[0].denominacionBien.disabled = false;
    document.forms[0].denominacionBien.className = "textareaTexto";
    document.forms[0].domicilio.disabled = false;
    document.forms[0].domicilio.className = "textareaTexto";
    comboCatalogaciones.activate();
    comboGradosProteccion.activate();
    comboRelacionesBien.activate();
...
function checkKeysLocal(evento,tecla) {
    ...
    if (teclaAuxiliar == 38 || teclaAuxiliar == 40){
        upDownTable(tab,lista,teclaAuxiliar,teclaAuxiliar);
    }
...
<html:hidden name="BienAndEspacioCatalogadoForm" property="tipoRegistro"/>
...
<tr>
    <td id="titulo" class="txttitblanco"><%= descriptor.getDescripcion("tit_bien")%></td>
</tr>
<tr>
...
<tr>
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("conUrb_denomBien")%>:</td>
    <!-- Codigo Tipo -->
    <td width="73%" align="left">
        <textarea id="obligatorio" class="textareaTextoObligatorio" cols="64" rows="5" name="denominacionBien"  maxlength="2" onkeydown="return textCounter(this,4000);" onkeypress="javascript:PasaAMayusculas(event);"></textarea>
    </td>
</tr>
<tr>
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("conUrb_domicilio")%>:</td>
    <!-- Codigo Tipo -->
    <td width="73%" align="left">
        <table width="100%" border="0" align="left" style="position: relative; left: -3px;">
            <tr>
                <td>
                    <input type="hidden" name="codigoDomicilio"/>
                    <input type="text" class="inputTextoObligatorio" size="62" name="domicilio" id="obligatorio" readOnly/>
                </td>
                <td id="domicilioImg">
                    <span class="fa fa-home" aria-hidden="true"  name="botonTer" style="cursor:'hand'" alt="Domicilios"
                    onclick="javascript:abrirDomicilios('consultaLocalizacion');"></span>
                </td>
                <td id="domicilioImgGrabar" style="display:none">
                    <span class="fa fa-home" aria-hidden="true"  name="botonTer" style="cursor:'hand'" alt="Domicilios"
                    onclick="javascript:abrirDomicilios('recargarDomicilioInicio');"></span>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("conUrb_catalogacion")%>:</td>
    <!-- Codigo Tipo -->
    <td width="73%" align="left">
        <input name="codigoCatalogacion" type="text" class="inputTexto" id="codCatalogacion" size="8"/>
        <input name="catalogacion" type="text" class="inputTexto" id="descCatalogacion" style="width:320;height:17" readonly/>
        <a id="anchorCatalogacion" name="anchorCatalogacion" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true"  id="botonCatalogacion" name="botonCatalogacion"
                style="cursor:hand;"></span></a>
    </td>
</tr>
<tr>
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("conUrb_grado")%>:</td>
    <!-- Codigo Tipo -->
    <td width="73%" align="left">
        <input name="codigoGradoProteccion" type="text" class="inputTexto" id="codGradoProteccion" size="8"/>
        <input name="gradoProteccion" type="text" class="inputTexto" id="descGradoProteccion"  style="width:320;height:17" readonly/>
        <a id="anchorGradoProteccion" name="anchorGradoProteccion" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true"  id="botonGradoProteccion" name="botonGradoProteccion"
                style="cursor:hand;"></span></a>
    </td>
</tr>
<tr>
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("conUrb_relacion")%>:</td>
    <!-- Codigo Tipo -->
    <td width="73%" align="left">
        <input name="codigoRelacionBien" type="text" class="inputTexto" id="codRelacionBien" size="8"/>
        <input name="relacionBien" type="text" class="inputTexto" id="descRelacionBien"  style="width:320;height:17" readonly/>
        <a id="anchorRelacionBien" name="anchorRelacionBien" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true"  id="botonRelacionBien" name="botonRelacionBien"
                style="cursor:hand;"></span></a>
    </td>
</tr>
<tr>
...
<script type="text/javascript">
    ...
    var comboCatalogaciones;
    var comboGradosProteccion;
    var comboRelacionesBien;
    ...
    function creaCombos() {
        ...
        comboCatalogaciones = new Combo("Catalogacion");
        comboGradosProteccion = new Combo("GradoProteccion");
        comboRelacionesBien = new Combo("RelacionBien");

    <logic:iterate id="elemento" name="BienAndEspacioCatalogadoForm" property="catalogaciones" scope="session">
        listaCod[cont] = ['<bean:write name="elemento" property="codigo" />'];
        listaDesc[cont] = ['<bean:write name="elemento" property="descripcion"/>'];
        cont = cont + 1;
    </logic:iterate>
        comboCatalogaciones.addItems(listaCod, listaDesc);

        cont = 0;
        listaCod = new Array();
        listaDesc = new Array();
    <logic:iterate id="elemento" name="BienAndEspacioCatalogadoForm" property="gradosProteccion" scope="session">
        listaCod[cont] = ['<bean:write name="elemento" property="codigo" />'];
        listaDesc[cont] = ['<bean:write name="elemento" property="descripcion"/>'];
        cont = cont + 1;
    </logic:iterate>
        comboGradosProteccion.addItems(listaCod, listaDesc);

        cont = 0;
        listaCod = new Array();
        listaDesc = new Array();
    <logic:iterate id="elemento" name="BienAndEspacioCatalogadoForm" property="relacionesBien" scope="session">
        listaCod[cont] = ['<bean:write name="elemento" property="codigo" />'];
        listaDesc[cont] = ['<bean:write name="elemento" property="descripcion"/>'];
        cont = cont + 1;
    </logic:iterate>
        comboRelacionesBien.addItems(listaCod, listaDesc);
    }
</script>
