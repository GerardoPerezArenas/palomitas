...
<%@ page import="es.altia.agora.interfaces.user.web.planeamiento.form.InstrumentoPlaneamientoForm"%>
...
<TITLE>::: Instrumentos de Planeamiento :::</TITLE>
<%
...
function borrarDatos(){
    ...
    document.forms[0].fechaVigencia.value = '';
    ...
    for (var i=0; i<document.forms[0].promotor.length;i++) {
        document.forms[0].promotor[i].checked=false;
    }
    activeTerceros();
...
function pulsarLimpiar() {
    ...
    document.forms[0].action = "<html:rewrite page='/planeamiento/LimpiarInstrumentoPlaneamiento.do'/>" +
...
function Inicio() {
    ...
    habilitarImagenCal("calFechaVigencia",true);
    ...
    <%
        ...
        if (numeroRegistro!=null) {
            ...
            String tipoRegistro = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getTipoRegistro();
            String anho = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getAnho();
            String numero = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getNumero();
            String codigoSubseccion = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getCodigoSubseccion();
            String codigoTipo = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getCodigoTipo();
            String codigoProcedimiento = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getCodigoProcedimiento();
            String numeroProcedimiento = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getNumeroProcedimiento();
            String codigoAmbito = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getCodigoAmbito();
            String parcela = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getParcela();
            String promotor = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getPromotor();
            String codigoOrganoAprobacion = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getCodigoOrganoAprobacion();
            String fechaVigencia = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getFechaVigencia();
            String fechaAprobacion = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getFechaAprobacion();
            String fechaBaja = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getFechaBaja();
            String fechaPublicacion = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getFechaPublicacion();
            String numeroPublicacion = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getNumeroPublicacion();
            if (numeroPublicacion==null) {
                numeroPublicacion = "";
            }
            String observaciones = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getObservaciones();
            if (observaciones==null) {
                observaciones = "";
            }
            String file = ((InstrumentoPlaneamientoForm) session.getAttribute("InstrumentoPlaneamientoForm")).getArchivo();
            if (file==null) {
                file = "";
            }
    %>
        ...
        rellenaDatosRegistro("<%=anho%>", "<%=numero%>", "<%=codigoSubseccion%>", "<%=codigoTipo%>", "<%=codigoProcedimiento%>", "<%=numeroProcedimiento%>",
                "<%=codigoAmbito%>", "<%=parcela%>", "<%=promotor%>", "<%=codigoOrganoAprobacion%>", "<%=fechaVigencia%>", "<%=fechaAprobacion%>",
...
function pulsarModificar() {
    ...
    document.forms[0].codigoTipo.className = "inputTextoObligatorio";
    document.forms[0].tipo.className = "inputTextoObligatorio";
    document.forms[0].codigoProcedimiento.className = "inputTextoObligatorio";
    document.forms[0].procedimiento.className = "inputTextoObligatorio";
    document.forms[0].numeroProcedimiento.className = "inputTexto";
    ...
    document.forms[0].fechaVigencia.className = "inputTxtFecha";
...
function pulsarGrabar() {
    if (validarFormulario()) {
        if (insertar) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/InsertarInstrumentoPlaneamiento.do'/>";
            document.forms[0].submit();
            insertar = false;
        }
        if (modificar || baja) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/ModificarInstrumentoPlaneamiento.do'/>";
            document.forms[0].submit();
            modificar = false;
            if (baja) {
                //                document.getElementById("trFechaBaja").style.display = "none";
...
//        borrarDatos();
        ...
        document.forms[0].promotor[0].checked=true;
...
function pulsarCancelar() {
    ...
    document.forms[0].codigoTipo.className = "inputTexto";
    document.forms[0].tipo.className = "inputTexto";
    document.forms[0].codigoProcedimiento.className = "inputTexto";
    document.forms[0].procedimiento.className = "inputTexto";
    document.forms[0].numeroProcedimiento.className = "inputTexto";
    ...
    document.forms[0].codigoTipo.readOnly = false;
    insertar = false;
    modificar = false;
    baja = false;
...
<%--function pulsarCancelarSalir() {
    window.location = "<html:rewrite page='/planeamiento/CargarInstrumentoPlaneamiento.do'/>?tipoRegistro=" + document.forms[0].tipoRegistro.value + "&consultando=true";
}   --%>
...
//    habilitarCampos();
//    document.getElementById("tabPage4").style.visibility = "visible";
    var action = "<html:rewrite page='/planeamiento/BuscarInstrumentoPlaneamiento.do'/>";
...
function pulsarGrabarAnotacion() {
    if (document.forms[0].fechaAnotacion.value!="") {
        document.forms[0].target = "oculto";
        document.forms[0].action = "<html:rewrite page='/planeamiento/InsertarAnotacion.do'/>";
        document.forms[0].submit();
        pulsarCancelarAnotacion();
    } else {
...
function pulsarEliminarAnotacion() {
    if(tabAnotacion.selectedIndex != -1) {
        document.forms[0].target = "oculto";
        document.forms[0].action = "<html:rewrite page='/planeamiento/EliminarAnotacion.do'/>";
        document.forms[0].submit();
        pulsarCancelarAnotacion();
    } else {
...
function pulsarGrabarRectificacion() {
    if (document.forms[0].fechaRectificacion.value!="") {
        document.forms[0].target = "oculto";
        document.forms[0].action = "<html:rewrite page='/planeamiento/InsertarRectificacion.do'/>";
        document.forms[0].submit();
        pulsarCancelarRectificacion();
    } else {
        jsp_alerta("A", "Debe rellenar el campo obligatorio");
...
function pulsarEliminarRectificacion() {
    if(tabRectificacion.selectedIndex != -1) {
        document.forms[0].target = "oculto";
        document.forms[0].action = "<html:rewrite page='/planeamiento/EliminarRectificacion.do'/>";
        document.forms[0].submit();
        pulsarCancelarRectificacion();
    } else {
        jsp_alerta('A', '<%=descriptor.getDescripcion("msjNoSelecFila")%>');
...
function pulsarListado() {
    var action = "<html:rewrite page='/planeamiento/VerListadoInstrumentoPlaneamiento.do'/>";
    document.forms[0].target="mainFrame";
    document.forms[0].action = action;
    document.forms[0].submit();
}
...
function pulsarSalir(){
    window.location = "<html:rewrite page='/planeamiento/SalirInstrumentoPlaneamiento.do'/>";
}
...
//    habilitarCampos();
    ...
    document.forms[0].target = "oculto";
    document.forms[0].action = "<html:rewrite page='/planeamiento/RellenarInstrumentoPlaneamiento.do'/>" +
                               "?numeroRegistro=" + numRegistro;
    document.forms[0].submit();
}
...
function activeTerceros() {
    if (document.forms[0].promotor[1].checked) {
        document.getElementById("terceros").style.color = "#0B3090";
        document.getElementById("terceros").style.cursor = "hand";
    } else {
        document.getElementById("terceros").src = "#f6f6f6";
        document.getElementById("terceros").style.cursor = "pointer";
    }
}

function pulsarPromotores(){
    if (document.forms[0].promotor[1].checked) {
        var source = "<html:rewrite page='/jsp/planeamiento/promotores.jsp'/>";
        var parameter;
	...
	'width=540,height=410,status='+ '<%=statusBar%>',function(){});
    }
}

function promotoresNoExistenInsercion(){
    insertar = true;
    jsp_alerta('A', '<%=descriptor.getDescripcion("msjNoPromotores")%>');
}

function promotoresNoExistenModificacion(){
    modificar = true;
    jsp_alerta('A', '<%=descriptor.getDescripcion("msjNoPromotores")%>');
}
...
function mostrarCalFechaVigencia() {
    if (document.getElementById("calFechaVigencia").className.indexOf("fa-calendar") != -1 )
        showCalendar('forms[0]','fechaVigencia',null,null,null,'','calFechaVigencia','',null,null,null,null,null,null,null);
}
...
function rellenaDatosRegistro(anho,numero,subseccion,tipo,procedimiento,numProc, ambito,parc,promotor,organo,vigencia,
    ...
    filterTipos();
    document.forms[0].codigoTipo.value = tipo;
    comboTipos.buscaLinea(tipo);
    document.forms[0].codigoProcedimiento.value = procedimiento;
    comboProcedimientos.buscaLinea(procedimiento);
    document.forms[0].numeroProcedimiento.value = numProc;
    document.forms[0].codigoAmbito.value = ambito;
    comboAmbitos.buscaLinea(ambito);
    document.forms[0].parcela.value = parc;
    document.forms[0].promotor[eval(promotor)].checked=true;
    activeTerceros();
    document.forms[0].codigoOrganoAprobacion.value = organo;
    comboOrganosAprobacion.buscaLinea(organo);
    document.forms[0].fechaVigencia.value = vigencia;
...
function deshabilitarCampos() {
    ...
    document.forms[0].numeroProcedimiento.disabled = true;
    document.forms[0].numeroProcedimiento.className = "inputTextoDeshabilitado"
    comboAmbitos.deactivate();
    document.forms[0].parcela.disabled = true;
    document.forms[0].parcela.className = "inputTextoDeshabilitado"
    document.forms[0].promotor.readOnly = true;
    comboOrganosAprobacion.deactivate();
    document.forms[0].fechaVigencia.disabled = true;
    document.forms[0].fechaVigencia.className = "inputTxtFechaDeshabilitado"
    document.getElementById("anchorFechaVigencia").style.display = "none";
...
function habilitarCampos() {
    if (!modificar && !baja) {
        ...
        document.forms[0].codigoTipo.disabled=false;
        document.forms[0].codigoSubseccion.readOnly = true;
        document.forms[0].codigoTipo.readOnly = true;
    }
    document.forms[0].anho.disabled = false;
    document.forms[0].numero.disabled = false;
    comboProcedimientos.activate();
    document.forms[0].numeroProcedimiento.disabled = false;
    document.forms[0].numeroProcedimiento.className = "inputTexto"
    comboAmbitos.activate();
    document.forms[0].parcela.disabled = false;
    document.forms[0].parcela.className = "inputTexto"
    document.forms[0].promotor.readOnly = false;
    comboOrganosAprobacion.activate();
    document.forms[0].fechaVigencia.disabled = false;
    document.forms[0].fechaVigencia.className = "inputTxtFecha";
    document.getElementById("anchorFechaVigencia").style.display = "inline";
...
<html:hidden name="InstrumentoPlaneamientoForm" property="tipoRegistro"/>
...
<tr>
    <td id="titulo" class="txttitblanco"><%= descriptor.getDescripcion("tit_insPlan")%></td>
</tr>
<tr>
...
<tr>
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("insPlan_tipo")%>:</td>
    <!-- Codigo Tipo -->
    <td width="73%" align="left">
        <input name="codigoTipo" type="text" class="inputTexto" id="codTipo" size="8"/>
        <input name="tipo" type="text" class="inputTexto" id="descTipo"  style="width:320;height:17" readonly/>
        <a id="anchorTipo" name="anchorTipo" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true"  id="botonTipo" name="botonTipo"
                style="cursor: pointer;"></span></a>
    </td>
</tr>
<tr>
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("insPlan_proc")%>:</td>
    <!-- Codigo Tipo -->
    <td width="73%" align="left">
        <input name="codigoProcedimiento" type="text" class="inputTexto" id="codProcedimiento" size="8"/>
        <input name="procedimiento" type="text" class="inputTexto" id="descProcedimiento"  style="width:254;height:17" readonly/>
        <a id="anchorProcedimiento" name="anchorProcedimiento" href=""><span class="fa fa-chevron-circle-down" aria-hidden="true"  id="botonProcedimiento" name="botonProcedimiento"
                style="cursor: pointer;"></span></a>
        <input name="numeroProcedimiento" type="text" class="inputTexto" id="numeroProcedimiento" size="8"/>
    </td>
</tr>
<tr>
...
<tr valign="center">
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("insPlan_promotor")%>:</td>
    <!-- Codigo Tipo -->
    <td width="73%" align="left" class="textoSuelto">
            <table width="100%">
                <tr>
                    <logic:iterate id="elemento" name="InstrumentoPlaneamientoForm" property="promotores" scope="session">
                    <td class="textoSuelto">
                        <input type="radio" name="promotor" class="textoSuelto" value="<bean:write name='elemento' property='codigo'/>" onclick="activeTerceros()"><bean:write name='elemento' property="descripcion"/></input>
                        <logic:equal name="elemento" property="codigo" value="1">
                            <span class="fa fa-search" aria-hidden="true" id="terceros"  name="botonT" alt="Buscar Promotor" onclick="javascript:pulsarPromotores();" style="cursor: pointer;"></span>
                        </logic:equal>
                    </td>
                    </logic:iterate>
                </tr>
            </table>
            <%--                                                                <span class="fa fa-users" aria-hidden="true"  name="botonTer" alt="Mantenimiento de Terceros" onclick="javascript:abrirTerceros();"></span>--%>
            <%--                                                                <input type="radio" name="codigoPromotor" class="textoSuelto" value="listado" checked></input>
       <br>
       <input type="radio" name="codigoPromotor" class="textoSuelto" value="registro" ></input>--%>
    </td>
</tr>
<tr>
    ...
    <!-- Codigo Tipo -->
    <td width="73%" align="left">
        <input name="codigoOrganoAprobacion" type="text" class="inputTextoObligatorio" id="codOrganoAprobacion" size="8"/>
        <input name="organoAprobacion" type="text" class="inputTextoObligatorio" id="descOrganoAprobacion"  style="width:320;height:17" readonly/>
...
<tr>
    <td width="27%" class="etiqueta"><%=descriptor.getDescripcion("insPlan_fecVigencia")%>:</td>
    <td width="33%" align="left">
        <input name="fechaVigencia" type="text" class="inputTxtFecha" size="18"
               onkeypress = "javascript:if (consultando) return soloCaracteresFechaConsultando(event); else return soloCaracteresFecha(event);"
               onblur = "javascript:return comprobarFecha(this);"
               onfocus = "this.select();"/>
        &nbsp;
        <a href="javascript:calClick();return false;"  id="anchorFechaVigencia" onClick="mostrarCalFechaVigencia();return false;" style="text-decoration:none;">
            <span class="fa fa-calendar" aria-hidden="true" name="calFechaVigencia" alt="Data" ></span>
        </a>
    </td>
</tr>
<tr id="trFechaBaja">
...
<script type="text/javascript">
    ...
    function creaCombos() {
        ...
        //        comboPromotores = new Combo("Promotor");

    <%-- Redefinimos el evento onclick para el combo de subsecciones --%>
        comboSubsecciones.view.onclick = function (){
            ...
            this.combo.ocultar();
            filterTipos();
            this.combo.cod.focus();
            return false;
        };

    <%-- Redefinimos el evento onkeydown para el combo de subsecciones --%>
        comboSubsecciones.base.onkeydown=function(){
            if(event.keyCode == 40){
              ...
              this.combo.ocultar();
                filterTipos();
              if(this.combo.cod) this.combo.cod.focus();
              else this.combo.des.focus();
          }else{
    ...
    <logic:iterate id="elemento" name="InstrumentoPlaneamientoForm" property="subsecciones" scope="session">
        ...
        listaCod = new Array();
        listaDesc = new Array();
    <logic:iterate id="elemento" name="InstrumentoPlaneamientoForm" property="tipos" scope="session">
<%--        listaCod[cont] = ['<bean:write name="elemento" property="codigo" />'];
        listaDesc[cont] = ['<bean:write name="elemento" property="descripcion"/>'];--%>
        listaTipos[cont] = ['<bean:write name="elemento" property="codigoSubseccion" />', '<bean:write name="elemento" property="codigo" />', '<bean:write name="elemento" property="descripcion"/>'];
        cont = cont + 1;
    </logic:iterate>
<%--        comboTipos.addItems(listaCod, listaDesc);--%>

        cont = 0;
        listaCod = new Array();
        listaDesc = new Array();
    <logic:iterate id="elemento" name="InstrumentoPlaneamientoForm" property="procedimientos" scope="session">
        listaCod[cont] = ['<bean:write name="elemento" property="codigo" />'];
        listaDesc[cont] = ['<bean:write name="elemento" property="descripcion"/>'];
        cont = cont + 1;
    </logic:iterate>
        comboProcedimientos.addItems(listaCod, listaDesc);

        cont = 0;
        listaCod = new Array();
        listaDesc = new Array();
    <logic:iterate id="elemento" name="InstrumentoPlaneamientoForm" property="ambitos" scope="session">
        listaCod[cont] = ['<bean:write name="elemento" property="codigo" />'];
        listaDesc[cont] = ['<bean:write name="elemento" property="descripcion"/>'];
        cont = cont + 1;
    </logic:iterate>
        ...
        listaCod = new Array();
        listaDesc = new Array();
    <logic:iterate id="elemento" name="InstrumentoPlaneamientoForm" property="organosAprobacion" scope="session">
        listaCod[cont] = ['<bean:write name="elemento" property="codigo" />'];
        listaDesc[cont] = ['<bean:write name="elemento" property="descripcion"/>'];
        cont = cont + 1;
    </logic:iterate>
   ...
   listaCod = new Array();
   listaDesc = new Array();
   <logic:iterate id="elemento" name="InstrumentoPlaneamientoForm" property="promotores">
       listaCod[cont] = ['<bean:write name="elemento" property="codigo" />'];
       listaDesc[cont] = ['<bean:write name="elemento" property="descripcion"/>'];
       cont = cont + 1;
   </logic:iterate>
   comboPromotores.addItems(listaCod, listaDesc);--%>
    }

    function filterTipos() {
        var codigo = document.getElementById("codSubseccion").value;
        var listaCod = new Array();
        var listaDesc = new Array();
        var j=0;
        if (codigo!="") {
            comboTipos.clearItems();
            for (var k=0;k<listaTipos.length;k++) {
                if (listaTipos[k][0]==codigo) {
                    listaCod[j] = listaTipos[k][1];
                    listaDesc[j] = listaTipos[k][2];
                    j++;
                }
            }
            comboTipos.addItems(listaCod, listaDesc);
