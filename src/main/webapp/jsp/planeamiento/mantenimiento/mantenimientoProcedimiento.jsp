...
<title>Mantenimiento de Procedimientos</title>
    ...
    if(tab.selectedIndex != -1) {
        if (validarFormulario()) {
            ...
            if(existe == 1) {
                ...
                document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/ModificarProcedimiento.do'/>";
...
function pulsarAlta() {
    ...
    if (validarFormulario()) {
        ...
        if(yaExiste == 0) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/InsertarProcedimiento.do'/>";
            document.forms[0].submit();
        } else {
...
function pulsarEliminar() {
    if(tab.selectedIndex != -1) {
        if (validarFormulario()) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/EliminarProcedimiento.do'/>";
            document.forms[0].submit();
            limpiarInputs();
        }
    } else {
...
function pulsarSalir(){
    window.location = "<html:rewrite page='/planeamiento/mantenimiento/SalirProcedimiento.do'/>";
}
    ...
    <tr>
        <td width="791px" height="415px">
            <table width="100%" height="100%" cellpadding="0px" cellspacing="1px" border="0px" bgcolor="#ffffff">
                <tr>
                    <td id="titulo" class="txttitblanco"><%= descriptor.getDescripcion("tit_mantProced")%></td>
                </tr>
                <tr>
                                    ...
                                    <table bgColor="#FFFFFF" width="700px" heigth="75%" align="center">
                                        <tr>
                                            ...
                                            <td width="10%" align="left">
                                                <input type="text" class="inputTextoObligatorio" id="obligatorio"  name="codigo"  size="8" maxlength="3" onkeyup="return xAMayusculas(this);" >
                                            </td>
                                            <!-- Descripcion -->
                                            <td width="90%" align="left">
                                                <input type="text" class="inputTextoObligatorio" id="obligatorio" name="descripcion" size="100" maxlength="45" onblur="return xAMayusculas(this);" onKeyUp="buscar();">
                                            </td>
                                        </tr>
                                    </table>
                                </td>
...
<script type="text/javascript">
    ...
    function cargaTabla(){
        ...
        lista = new Array();
    <logic:iterate id="elemento" name="MantenimientoProcedimientosForm" property="procedimientos">
