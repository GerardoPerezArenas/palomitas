...
<title>Mantenimiento de Órganos de Aprobación</title>
    ...
    if(tab.selectedIndex != -1) {
        if (validarFormulario()) {
            ...
            if(existe == 1) {
                ...
                document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/ModificarOrganoAprobacion.do'/>";
...
function pulsarAlta() {
    ...
    if (validarFormulario()) {
        ...
        if(yaExiste == 0) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/InsertarOrganoAprobacion.do'/>";
            document.forms[0].submit();
        } else {
...
function pulsarEliminar() {
    if(tab.selectedIndex != -1) {
        if (validarFormulario()) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/EliminarOrganoAprobacion.do'/>";
            document.forms[0].submit();
            limpiarInputs();
        }
    } else {
...
function pulsarSalir(){
    window.location = "<html:rewrite page='/planeamiento/mantenimiento/SalirOrganoAprobacion.do'/>";
}
    ...
    <tr>
        <td width="791px" height="415px">
            <table width="100%" height="100%" cellpadding="0px" cellspacing="1px" border="0px" bgcolor="#ffffff">
                <tr>
                    <td id="titulo" class="txttitblanco"><%= descriptor.getDescripcion("tit_mantOrganoAprob")%></td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    function cargaTabla(){
        ...
        lista = new Array();
    <logic:iterate id="elemento" name="MantenimientoOrganosAprobacionForm" property="organosAprobacion">
