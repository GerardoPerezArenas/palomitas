...
<title>Mantenimiento de Catalogaciones</title>
    ...
    if(tab.selectedIndex != -1) {
        if (validarFormulario()) {
            ...
            if(existe == 1) {
                ...
                document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/ModificarCatalogacion.do'/>";
...
function pulsarAlta() {
    ...
    if (validarFormulario()) {
        ...
        if(yaExiste == 0) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/InsertarCatalogacion.do'/>";
            document.forms[0].submit();
        } else {
...
function pulsarEliminar() {
    if(tab.selectedIndex != -1) {
        if (validarFormulario()) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/EliminarCatalogacion.do'/>";
            document.forms[0].submit();
            limpiarInputs();
        }
    } else {
...
function pulsarSalir(){
    window.location = "<html:rewrite page='/planeamiento/mantenimiento/SalirCatalogacion.do'/>";
}
...
<table width="100%" cellpadding="0px" cellspacing="0px">
    ...
    <table width="100%" height="100%" cellpadding="0px" cellspacing="1px" border="0px" bgcolor="#ffffff">
        <tr>
            <td id="titulo" class="txttitblanco"><%= descriptor.getDescripcion("tit_mantCatalogacion")%></td>
        </tr>
        <tr>
        ...
        <!-- Sombra lateral. -->
        <td width="1px" height="415px">
            <table width="100%" height="415px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td height="1px" bgcolor="#B0BDCD"></td>
                </tr>
                <tr>
                    <td height="414px" bgcolor="#393939"></td>
                </tr>
            </table>
        </td>
        <!-- Fin sombra lateral. -->
...
<script type="text/javascript">
    ...
    function cargaTabla(){
        ...
        lista = new Array();
    <logic:iterate id="elemento" name="MantenimientoCatalogacionesForm" property="catalogaciones">
