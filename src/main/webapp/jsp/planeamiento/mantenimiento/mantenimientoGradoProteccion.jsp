...
<title>Mantenimiento de GradosProteccion</title>
    ...
    if(tab.selectedIndex != -1) {
        if (validarFormulario()) {
            ...
            if(existe == 1) {
                ...
                document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/ModificarGradoProteccion.do'/>";
...
function pulsarAlta() {
    ...
    if (validarFormulario()) {
        ...
        if(yaExiste == 0) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/InsertarGradoProteccion.do'/>";
            document.forms[0].submit();
        } else {
...
function pulsarEliminar() {
    if(tab.selectedIndex != -1) {
        if (validarFormulario()) {
            document.forms[0].target = "oculto";
            document.forms[0].action = "<html:rewrite page='/planeamiento/mantenimiento/EliminarGradoProteccion.do'/>";
            document.forms[0].submit();
            limpiarInputs();
        }
    } else {
...
function pulsarSalir(){
    window.location = "<html:rewrite page='/planeamiento/mantenimiento/SalirGradoProteccion.do'/>";
}
...
<table width="100%" cellpadding="0px" cellspacing="0px">
    <tr>
        ...
        <table width="100%" height="100%" cellpadding="0px" cellspacing="1px" border="0px" bgcolor="#ffffff">
            <tr>
                <td id="titulo" class="txttitblanco"><%= descriptor.getDescripcion("tit_mantGradoProtec")%></td>
            </tr>
            <tr>
...
<script type="text/javascript">
    ...
    function cargaTabla(){
        ...
        lista = new Array();
    <logic:iterate id="elemento" name="MantenimientoGradosProteccionForm" property="gradosProteccion">
