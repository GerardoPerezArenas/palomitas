...
<HTML>
    ...
    <head>
        ...
        <TITLE>
            <%=descriptor.getDescripcion("res_tituloS")%>
        </TITLE>
...
function pulsarCancelar() {
    document.formulario.opcion.value = "salirS";
...
function pulsarAceptar(){
    ...
    document.forms[0].opcion.value = "numeroS";
    ...
    <div id="titulo" class="txttitblancoder"><%=descriptor.getDescripcion("res_numeroS")%></div>
    <div id="tabla" class="contenidoPantalla">
        <table style="width: 40%" align="center">
            <tr>
                <TD colspan="2" class="sub3titulo" style="width:40%;text-align:center">
                    <%=descriptor.getDescripcion("res_pregunta1")%>
                </TD>
            </tr>
            <TR>
            <TR>	
        ...
        <div class="botoneraPrincipal">
            <input type= "button" class="botonGeneral" value=<%=descriptor.getDescripcion("gbConfirmar")%> name="cmdAceptar" onclick = "pulsarAceptar();">
