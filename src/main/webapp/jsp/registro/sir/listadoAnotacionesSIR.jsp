...
<SCRIPT type="text/javascript"> 
    ...
    function cargarInicio() {
        ...
        console.log("Entramos en cargarInicio");
        ...
        console.log("recuperamos el tipoOrdenacion");
        idOrden=<bean:write name="MantAnotacionRegistroForm" property="columna"/>;--%>
        console.log("recuperamos el idOrden");
        ...
        console.log("Entramos en el iterate");
        ...
        console.log("salimos del iterate");
        ...
        console.log("las columnas recuperadas: ");
        console.dir(cols);
    ...
    function cargaPagina(numeroPagina){
        consle.log("Entramos en cargaPagina: "+numeroPagina);
        lista = new Array();
    ...
    function inicializaLista(){
        console.log("Entramos en inicializaLista");

        //lista si el unlistado paginable
        var DOT_COMMA = ";";
        var valorCheck = "2025" + DOT_COMMA + "3000" + DOT_COMMA + "E"+ DOT_COMMA + "0";
        var check = '<input type="checkbox" class="checkLinea" onclick="pulsarCheck()" value="'+valorCheck+'" />';
        listaSel[0]  = [check,"estado2","procedimiento","expediente","19","estado+ejer+'/'+numAnot","entrSal","5",
            "6","nombreFormateado","asunto","12","entrada"];
    ...
    function seleccionRegistro(indice) {
        ...
        document.forms[0].posicionAnotacion.value = ind + 1;
