...
<head>
 ...
 <!--[if lte IE 9]> 
  ...
  <![endif]-->   
  <jsp:include page="/jsp/registro/externo/tpls/app-constants.jsp" />
</head>
<body style="margin:0">
    ...
    <iframe src="<c:url value='/registroExterno/RegistroExterno.do?opcion=cargarDefecto'/>" name="mainFrame" class="iframeMainFrame" noresize scrolling="NO" frameborder="0" marginwidth="0" marginheight="0"></iframe>
