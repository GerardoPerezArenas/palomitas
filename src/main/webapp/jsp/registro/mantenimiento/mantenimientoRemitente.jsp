...
<html>
    <head>
        <title> Mantenimiento Remitentes</title>
                ...
                if(tab.selectedIndex != -1) {
                    if (validarFormulario()) {
                        ...
                        if(existe == 0){
                            ...
                            document.forms[0].action = '<%=request.getContextPath()%>/MantRemitente.do';
...
document.onkeydown=checkKeys;
    ...
    <form method="post">
        ...
        <div id="titulo" class="txttitblanco"><%=descriptor.getDescripcion("titMantRem")%></div>
        <div class="contenidoPantalla" valign="top">
        <!-- Tabla de Datos -->
        <table>
            <tr>
                <td>
                    <div id="tabla" width="100%" height="100%" valign="top" bgcolor="#e6e6e6" border="0"></div>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <div class="botoneraPrincipal">
            <input type= "button" class="botonGeneral" value=<%=descriptor.getDescripcion("gbAlta")%> name="cmdAlta" onClick="pulsarAlta();" alt="<%= descriptor.getDescripcion("toolTip_bAltaTRem")%>" title="<%= descriptor.getDescripcion("toolTip_bAltaTRem")%>">
...
<script>
            ...
            tab.addColumna('130','center','<%=descriptor.getDescripcion("gEtiq_codigo")%>',715);
                tab.addColumna('628','center','<%=descriptor.getDescripcion("gEtiq_desc")%>',710);
                    tab.addColumna('130','center','Activo');
