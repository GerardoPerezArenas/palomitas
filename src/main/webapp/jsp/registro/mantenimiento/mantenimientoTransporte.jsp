    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/css/font-awesome-4.6.2/less/animated.less'/>" media="screen" >
                ...
                if(tab.selectedIndex != -1) {
                    if (validarFormulario()) {
                        ...
                        if(existe == 0){
                            ...
                            document.forms[0].action = '<%=request.getContextPath()%>/MantTransporte.do';
        ...
        function pulsarAlta() {
            ...
            if (validarFormulario()) {
               ...
               if(cod=='0' || cod=='00' ){       
                   jsp_alerta('A','El código del transporte no puede ser 0');
                }else if(yaExiste == 0) {
                    if (modificar==1){
                        document.forms[0].idModificar.value=ide;
                    }else{
...
document.onkeydown=checkKeys;
    ...
    <form method="post">
        ...
        <div id="titulo" class="txttitblanco"><%=descriptor.getDescripcion("titMantTrans")%></div>
        <div class="contenidoPantalla" valign="top">
            <!-- Tabla de Datos -->
            <table>
                <tr>
                    <td>
                        <div id="tabla" width="100%" valign="top" bgcolor="#e6e6e6" border="0"></div>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <input type="text" class="inputTextoObligatorio" id="obligatorio"  
                               name="codigo"  maxlength="2" onkeyup="return xAMayusculas(this);"
                               style="width:14.5%">
                        <!-- Descripcion -->
                        <input type="text" class="inputTextoObligatorio" id="obligatorio" 
                               name="txtNomeDescripcion" maxlength="70" onblur="return xAMayusculas(this);"
                               style="width:70%">
                        <!-- Activo -->
                        <input type="checkbox"  id="obligatorio" name="activo" style="width:12%">
                    </td>
                </tr>
            </table>
            <!--Final de Tabla de Datos-->
        <div class="botoneraPrincipal">
            <input type= "button" class="botonGeneral" value=<%=descriptor.getDescripcion("gbAlta")%> name="cmdAlta" onClick="pulsarAlta();" alt="<%= descriptor.getDescripcion("toolTip_bAltaTTrans")%>" title="<%= descriptor.getDescripcion("toolTip_bAltaTTrans")%>">
...
<script>
            ...
            tab.addColumna('130','center','<%=descriptor.getDescripcion("gEtiq_codigo")%>',715);
            tab.addColumna('628','center','<%=descriptor.getDescripcion("gEtiq_desc")%>',710);
            tab.addColumna('130','center','<%=descriptor.getDescripcion("etiq_porDef")%>');
