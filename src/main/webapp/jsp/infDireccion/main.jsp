...
<head>
  ...
  <![endif]-->  
  <jsp:include page="/jsp/infDireccion/tpls/app-constants.jsp" />
</head>
<body style="margin:0">
    ...
    <iframe src="<c:url value='/jsp/infDireccion/informesDireccion.jsp'/>" name="mainFrame" class="iframeMainFrame" noresize scrolling="NO" frameborder="0" marginwidth="0" marginheight="0"></iframe>
