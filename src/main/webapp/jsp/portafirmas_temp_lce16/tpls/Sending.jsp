...
<div id="divframeSending" style="position: absolute; top:240px; z-index:9995; display: none;" align="center">
    <table width="100%"> <tr> <td width="100%" align="center">
    
    </td> </tr> </table>
</div>
<!-- Div para la barra de progreso -->
<div id="hidepageSending" style="position: absolute; top:240px; z-index:9995; display: none;">
