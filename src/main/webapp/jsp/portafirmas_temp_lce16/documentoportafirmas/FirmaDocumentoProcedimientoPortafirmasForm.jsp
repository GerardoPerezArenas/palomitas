...
<%
    ...
    try {
        ...
        if (hVirtual.equals("")) host = protocolo + "://" + request.getHeader("host") + request.getContextPath() + "/portafirmas/documentoportafirmas/ProcessFirmaDocumentoProcedimientoPortafirmas.do";
        else host = hVirtual + request.getContextPath() + "/portafirmas/documentoportafirmas/ProcessFirmaDocumentoProcedimientoPortafirmas.do";
    } catch (Exception e) {
        e.printStackTrace();
    }//try-catch
%>
            ...
            <script type="text/javascript">
                ...
                function btnFirmar_click(theSender, theForm) {
                    ...
                    if ( (theSender) && (theForm) ){         
                        ...
                        var url =  getUrlForDownloadProcedimientoDocument(
                        theForm.idMunicipio.value, theForm.idEjercicio.value, 
                        theForm.idNumeroExpediente.value, theForm.idNumeroDocumento.value,
                        theForm.idProcedimiento.value);
                ...
                if ( (theSender) && (theForm) ) {
                   ...
                   if(numeroExpediente==null || numeroExpediente==""){
                        ...
                        abrirXanelaAuxiliar(url,datos,
                            'width=973,height=685,status=no',function(resultado){});
                    }
                }
            }
    ...
    <tiles:put name="content" type="string">
        <tiles:insert page="/jsp/portafirmas/tpls/AltiaTemplate.jsp" flush="false">
            ...
            <tiles:put name="altia-app-form-content" type="string">
                <html:form action="/portafirmas/documentoportafirmas/ProcessFirmaDocumentoProcedimientoPortafirmas.do">
