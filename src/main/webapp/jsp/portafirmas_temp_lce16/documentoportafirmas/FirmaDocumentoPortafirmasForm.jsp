...
<%
    ...
    try {
        ...
        if (hVirtual.equals("")) host = protocolo + "://" + request.getHeader("host") + request.getContextPath() + "/portafirmas/documentoportafirmas/ProcessFirmaDocumentoPortafirmas.do";
        else host = hVirtual + request.getContextPath() + "/portafirmas/documentoportafirmas/ProcessFirmaDocumentoPortafirmas.do";
    } catch (Exception e) {
        e.printStackTrace();
    }//try-catch
%>
        ...
        <script type="text/javascript">
            ...
            function btnFirmar_click(theSender, theForm) { 
                ...
                if ( (theSender) && (theForm) ) {
                    if (theForm.tipoDocumento.value == 0) {
                        var url = getUrlForDownloadDocument(theForm.idMunicipio.value, theForm.idNumeroExpediente.value,
                        theForm.idTramite.value, theForm.idOcurrenciaTramite.value,
                        theForm.idNumeroDocumento.value, "documento", theForm.editorTexto.value);
                    } else {
                        var url = getUrlForDownloadRelationDocument(theForm.idMunicipio.value, theForm.idNumeroExpediente.value,
                        theForm.idTramite.value, theForm.idOcurrenciaTramite.value,
                        theForm.idNumeroDocumento.value, "documento", theForm.editorTexto.value);
                    }//if (theForm.tipoDocumento.value == 0) 
