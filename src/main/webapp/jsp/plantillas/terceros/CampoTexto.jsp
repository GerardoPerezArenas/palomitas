...
String mensaje = descriptor.getDescripcion("msjNumMaximoCampoTex");
...
if (consultando!=true) modificaVariableCambiosCamposSupl();
 ...
 <input type="text" name="<%= name %>" value="<%=valor%>"
    ...
    style="width:90%;text-transform: none" onkeyup="return xValidarCaracteres(this)" onblur="javascript:if (!validarLongitudTexto(this)) {document.getElementById('<%=name%>').value = '';focus(this);}">
