...
<html>
    ...
    <div class="txttitblanco">
        <%=descriptor.getDescripcion("tit_listVias")%>
    </div>
    <div class="contenidoPantalla">
        <div id="tabla"></div>
        <div class="botoneraPrincipal">
            <%if (bAltaViaDirecta) {%>
                <input type="button" class="botonGeneral" value="<%=descriptor.getDescripcion("gEtiq_NuevoVial")%>" name="cmdAltaVia" onclick="iniciarAltaViaDirecta();" accesskey="V">
            <%}%>
...
<script type="text/javascript">
            ...
            function checkKeysLocal(evento,tecla) {
                var event = (evento) ? evento : ((window.event) ? window.event : "");
                var tecla = "";
                ...
                if ( (tecla == 40) || (tecla == 38)){
                    upDownTable(tab,listaVias,tecla);
                                                    }
                                                }
