            ...
            function comprobarFecha(inputFecha){
                ...
                function pulsarAceptar(){	
                    if(validarFormulario()){
                        self.parent.opener.retornoXanelaAuxiliar(document.forms[0].fechaOperacion.value);
                    }
                }	
...
<form	action="" method="post"	name="formulario"	id="formulario">
    ...
    <div id="titulo" class="txttitblanco"><%=descriptor.getDescripcion("Etiq_FechaOperaciones")%></div>
    <div class="contenidoPantalla">                                                                                                                                                
        <table width="100%">	
            <tr style="height: 140px; vertical-align: top">
                <td style="width: 40%" class="etiqueta"><%=descriptor.getDescripcion("Etiq_FechaOperacione")%>:</td>
                <td>
                    <input class="inputTxtFechaObligatorio"	type="text"	size="11" 
                           maxlength="10" name="fechaOperacion" 
                    ...
                    <a name="anchorDesde"	id="anchorDesde" 
                       ...
                       onClick="mostrarCalendario('Desde','fechaOperacion');return false;"  onblur="ocultarCalendarioOnBlur(event); return false;"
