...
<body class="bandaBody" onload="javascript:{ }">
    <div id="titulo" class="txttitblanco">
              <% if(codAplicacion == 9) { // Administrador local del sistema %>
                    <%= descriptor.getDescripcion("titAdminLocal") %>
                <% } else if(codAplicacion == 5) { //Administrador general del sistema %>                                        	
                        <%= descriptor.getDescripcion("titAdminGeneral") %>
              <% } %>
    </div>
