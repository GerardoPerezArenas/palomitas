...
<tiles:insert page="/jsp/integracionsw/tpls/WindowTemplate.jsp" flush="true">
	<tiles:put name="title" type="string">
        <fmt:message key='IntegracionSW.Application.title'/>
    </tiles:put>
	...
	<tiles:put name="content" type="string">
		<tiles:insert page="/jsp/integracionsw/tpls/AltiaTemplate.jsp" flush="false">
