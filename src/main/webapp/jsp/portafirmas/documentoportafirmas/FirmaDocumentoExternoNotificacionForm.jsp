...
<%
    ...
    try {
        ...
        host = hVirtual + request.getContextPath() + "/sge/documentofirma/ProcessFirmaDocExternoNotificacion.do";
    } catch (Exception e) {
        e.printStackTrace();
    }//try-catch
%>
            ...
            <script type="text/javascript">
                ...
                function btnFirmar_click(theSender, theForm) {
                    ...
                    if ( (theSender) && (theForm) ) {
                        ...
                        var url = getUrlForDownloadDocExtNotificacion(
                                theForm.codAdjunto.value,
