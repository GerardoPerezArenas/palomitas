    ...
    <tiles:put name="content" type="string">
        <tiles:insert page="/jsp/portafirmas/tpls/AltiaTemplate.jsp" flush="false">
            ...
            <tiles:put name="altia-app-form-content" type="string">
                <html:form action="/portafirmas/documentoportafirmas/ProcessRechazoDocumentoExternoNotificacionPortafirmas.do">
                    ...
                    <center>
                        ...
                        <tr>
                            <td align="center">
                                <input type="button" class="boton" name="btnRechazar" value="<fmt:message key='Buttons.reject'/>" onclick="btnRechazar_click(this,this.form)">
                                <input type="button" class="boton" name="btnClose" value="<fmt:message key='Buttons.cancel'/>" onclick="btnCloseRechazoDocumentoProcedimiento_click(this,this.form)">
                            </td>
                        </tr>
                        </table>
                    </center>
