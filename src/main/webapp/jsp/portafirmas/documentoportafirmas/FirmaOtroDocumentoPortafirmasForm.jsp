...
<%
    ...
    try {
        ...
        if (hVirtual.equals("")) host = protocolo + "://" + request.getHeader("host") + request.getContextPath() + "/portafirmas/documentoportafirmas/ProcessFirmaOtroDocumentoPortafirmas.do";
        else host = hVirtual + request.getContextPath() + "/portafirmas/documentoportafirmas/ProcessFirmaOtroDocumentoPortafirmas.do";
    } catch (Exception e) {
        e.printStackTrace();
    }//try-catch
%>
 ...
 <meta http-equiv="X-UA-Compatible" content="IE=9"/>
	...
	<tiles:put name="title" type="string">
        <fmt:message key='Portafirmas.FirmaOtroDocumentoPortafirmasForm.title'/>
    </tiles:put>
        ...
        <script type="text/javascript">
            ...
            function btnFirmar_click(theSender, theForm) {
                ...
                if ( (theSender) && (theForm) ) {                       
                    ...
                    var url =  getUrlForDownloadExternalDocument(theForm.idNumeroDocumento.value);
                    ...
                    if (CLIENTE_FIRMA=="FLEXIA"){
                        ...
                        ficheroFirmado = firmarFichero(rutaFicheroCliente);
            ...
            function btnDocumentacionAnexaExpediente_click(theSender, theForm) {                                 
                if ( (theSender) && (theForm) ) {
                   ...
                   var codDocumento = theForm.idNumeroDocumento.value;
    ...
    <tiles:put name="content" type="string">
            <tiles:insert page="/jsp/portafirmas/tpls/AltiaTemplate.jsp" flush="false">
                    ...
                    <html:form action="/portafirmas/documentoportafirmas/ProcessFirmaOtroDocumentoPortafirmas.do">
