...
<body class="alertaShowModal" style="overflow-x: hidden; overflow-y: auto">
                ...
                <form action="" method="post" target="_self">
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFFF" class="txtverdebold" align="left"  id="alert_stl">
                          <div class="contenidoShowModal">
