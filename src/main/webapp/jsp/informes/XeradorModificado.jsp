...
<body  class="bandaBody" onLoad="pleaseWait('off');"> <!-- onLoad="inicializar();" --><!---->
    ...
    <div class="contenidoPantalla">
        <div class="tab-pane" id="tab-pane-1">
            ...
            <!-- PESTAÑA 1 -->
            <div class="tab-page" id="tabPage1" style="height:325;">

                <h2 class="tab"><!--Datos informe  -->Datos informe<!-- %=descriptor.getDescripcion("tit_BuzEnt")%>--></h2>

                <script type="text/javascript">tp1_p1 = tp1.addTabPage( document.getElementById( "tabPage1" ) );</script>


            <table width="700px" border="0px" cellspacing="0px" cellpadding="0px">
                <tr>
                    <td width="100%" colspan="2" height="18px" bgcolor="#DCDCCC" class="etiqueta">&nbsp;&nbsp;<%=descriptor.getDescripcion("gEtiq_CampInforme")%></td>
                </tr>
                <tr>
                    <td width="100%" align="center" valign="top">
                        <table width="100%" cellspacing="0px" cellpadding="10px" border="0px" bgcolor="#ffffff" valign="top">
                            <tr>
                                <td width="25%" class="etiqueta"><%=descriptor.getDescripcion("gNome_Informe")%> :</td>
                                <td width="75%" class="textoc">&nbsp;<html:text property="textNomeInforme" styleId="textNomeInforme" size="20" maxlength="30" styleClass="inputTexto"/></td>
                            </tr>
                            <tr>
                                <td width="25%" class="etiqueta"><%=descriptor.getDescripcion("gDesc_Informe")%> :</td>
                                <td width="75%" class="textoc">&nbsp;<html:text property="textDescripcion" styleId="textDescripcion" size="60" maxlength="256"  styleClass="inputTexto"/></td>
                            </tr>
                            <tr>
                                <td width="25%" class="etiqueta"><%=descriptor.getDescripcion("gEnt_Informe")%> :</td>
                                <td width="75%" class="textoc">
                                    <html:text style="visibility:hidden;height:0;width:0;" styleId="codEntidadeInforme" property="codEntidadeInforme"/> <input class="inputTexto" type="text" id="descEntidadeInforme" name="descEntidadeInforme" style="width:200;">
                                    <a href="" id="anchorEntidadeInforme" name="anchorEntidadeInforme"><span class="fa fa-chevron-circle-down" aria-hidden="true"  id="botonEntidadeInforme" name="botonEntidadeInforme" style="cursor:hand;"></span></a>
                                    <html:select property="comboEntidadeInforme" styleId="comboEntidadeInforme" styleClass="pequena" style="visibility:hidden;height:0;width:0;" onchange="javascript:EventoComboEntidades();"></html:select></td>
                                    <html:text style="visibility:hidden;height:0;width:0;" styleId="codFormatoInforme" property="codFormatoInforme"/> <input class="inputTexto" type="text" id="descFormatoInforme" name="descFormatoInforme" style="width:200;visibility:hidden;">
          ...
          <div class="tab-page" id="tabPage2"  style="height:325;">
                ...
                <tr>
                    <td width="100%" align="center" valign="top" >
                        <table width="100%" cellspacing="0px" cellpadding="0px" border="0px" bgcolor="#ffffff" valign="top">
                            ...
                            <tr>
                                <td width="40%" class="etiqueta" align="center"><%=descriptor.getDescripcion("gCampos_Dispon")%></td>
                                <td width="10%" align="center"></td>
                                <td width="40%" class="etiqueta" align="center"><%=descriptor.getDescripcion("gCampos_Elegid")%></td>
                                <td width="10%" align="center"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td width="45%" class="textoc" align="right">
                                    <select name="comboCamposDisponibles" id="comboCamposDisponibles" multiple size="15" style="width:275;"></select>
                                </td>
                                <td width="10%" class="textoc" align="center">
                                    <table border="0px" cellpadding="0px" cellspacing="0px"  width="100%">
                                        <tr>
                                            <td width="100%" align="center"><INPUT NAME="BotonAsignar" TYPE="button" class="botonGeneral" style="width:30;height:30;" ONCLICK="PulsaBoton(event);" VALUE="&gt;"></td>
                                        </tr>
                                        <tr><td height="5"></td></tr>
                                        <tr>
                                            <td width="100%" align="center"><INPUT NAME="BotonAsignarTodos" TYPE="button" class="botonGeneral" style="width:30;height:30;" ONCLICK="PulsaBoton(event);" VALUE="&gt;&gt;"></td>
                                        </tr>
                                        <tr><td height="5"></td></tr>
                                        <tr>
                                            <td width="100%" align="center"><INPUT NAME="BotonDesAsignar" TYPE="button" class="botonGeneral" style="width:30;height:30;" ONCLICK="PulsaBoton(event);" VALUE="&lt"></td>
                                        </tr>
                                        <tr><td height="5"></td></tr>
                                        <tr>
                                            <td width="100%" align="center"><INPUT NAME="BotonDesAsignarTodos" TYPE="button" class="botonGeneral" style="width:30;height:30;" ONCLICK="PulsaBoton(event);" VALUE="&lt;&lt;"></td>
                                        </tr>
                                    </table>
                                </td>
                                <td width="45%" class="textoc" align="left">
                                    <html:select property="comboCamposElexidos" styleId="comboCamposElexidos" multiple="true" size="15" style="width:275;"></html:select>
                                </td>
                                <td width="10%" align="center">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td><a href="#" onclick="AccionAbaixo();"><span class="fa fa-chevron-circle-down" aria-hidden="true"  id="imgBotonArriba"  style="cursor:hand;"/></a><INPUT style="width:30;height:30;visibility:hidden;" TYPE="button" class="botonGeneral" NAME="BotonAbaixo" VALUE="V" ONCLICK="PulsaBoton(event);"></span></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
          ...
          <div class="tab-page" id="tabPage3"  style="height:325;">
            ...
            <table width="700px" border="0px" cellspacing="0px" cellpadding="0px" >
                ...
                <tr>
                    <td width="100%" bgcolor="#e6e6e6" align="center" valign="top" colspan="2">
                        <table width="100%" height="70" cellspacing="0px" cellpadding="5" border="0px" bgcolor="#ffffff" valign="top">
                            <tr>
                                <td width="100%" align="center">
                                    <table width="50%" cellspacing="0" cellpadding="3px" border="0">
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="textoc">
                                                <html:text style="visibility:hidden;height:0;width:0;" styleId="codCampoOrdenacion_3" property="codCampoOrdenacion_3"/> <input class="inputTexto" type="text" id="descCampoOrdenacion_3" name="descCampoOrdenacion_3" style="width:200;">
          ...
          <div class="tab-page" id="tabPage4"  style="height:325;">
            ...
            <table width="700px" border="0px" cellspacing="0px" cellpadding="0px">
                <tr>
                    <td width="100%" colspan="2" height="18px" bgcolor="#DCDCCC" class="etiqueta">&nbsp;&nbsp;<%=descriptor.getDescripcion("gEtiq_FiltInforme")%></td>
                </tr>
                <tr>
                    <td width="100%" bgcolor="#e6e6e6" align="center" valign="top" colspan="2">
                        <table width="100%" height="70" cellspacing="0px" cellpadding="5" border="0px" bgcolor="#ffffff" valign="top">
                            ...
                            <tr>
                                <td class="textoc">
                                    <html:text style="visibility:hidden;height:0;width:0;" styleId="codOperador_6" property="codOperador_6"/><input class="inputTexto" type="text" id="descOperador_6" name="descOperador_6" style="width:50;">
                            ...
                            <tr>
                                <td class="textoc">
                                    <html:text style="visibility:hidden;height:0;width:0;" styleId="codOperador_7" property="codOperador_7"/><input class="inputTexto" type="text" id="descOperador_7" name="descOperador_7" style="width:50;">
...
function AccionAceptar() 
{
 ...
 function AceptarEngadir()
 {
 	...
 	} else alert(mensaxeIncorrectoInforme);
 }
...
function CargaCombosOperador(cond){
	...
	for (var i=1;i<8;i++){
		...
		if (!(cond)) {
		  ...
		  comboOrde.addItems(codConectorSin,descConectorSin);
		}
	}
...
<%
	...
	try
	{
		...
		if (request.getParameter("op").equals("A")) cualApli=request.getParameter("id");
		else cualApli=request.getParameter("codApliInforme");
...
function callbackCubreControlesInforme(vInforme){	
...
function campoValor_onKeyPress(cual,event){
	if (TiposActualesCamposCondicion[cual]=='N') return SoloDigitos(event);
}
