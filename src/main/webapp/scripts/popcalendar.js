...
//var weekString="Sem"
//var scrollLeftMessage="Pulse aquí para ir al mes anterior. Mantenga pulsado para retroceder meses	automáticamente."
//var scrollRightMessage="Pulse aquí para ir al mes siguiente. Mantenga pulsado para avanzar meses automáticamente."
//var selectMonthMessage="Pulse aquí para seleccionar un mes."
//var selectYearMessage="Pulse aquí para seleccionar un año."
//var selectDateMessage="Seleccionar el día [date]."
...
function constructCalendar(){
    ...
    if(showWeekNumber==1)sHTML+="<td width=27><b>"+weekString+"</b></td><td width=1 rowspan=7 bgcolor='#d0d0d0' style='padding:0px'><img src='"+imgDir+"divider.gif' width=1></td>";
    for(i=0;i<7;i++){
