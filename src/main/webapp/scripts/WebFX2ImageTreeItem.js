...
function WebFX2ImageTreeItem(sText, sAction, eParent, sIcon, sOpenIcon, sEstilo, sSrcImage, sActionImagen, sSrcImage2, sActionImagen2) {  
  this._srcImage =(sSrcImage)?sSrcImage:webFXTreeConfig.srcImage;
  this._srcImage2 =(sSrcImage2)?sSrcImage2:webFXTreeConfig.srcImage;
  this._action = (sActionImagen)?sActionImagen:"";
  this._action2 = (sActionImagen2)?sActionImagen2:"";
	this.base = WebFXTreeItem;
	this.base(sText, sAction, eParent, sIcon, sOpenIcon, sEstilo);
  
}

WebFX2ImageTreeItem.prototype = new WebFXTreeItem;

WebFX2ImageTreeItem.prototype.desHabilitarImagenes = function(b) { 
...
WebFX2ImageTreeItem.prototype.toString = function (nItem, nItemCount) {
  ...
  // insertar imagen
  str += "&nbsp;<span id=\"" + this.id + "-imagen2\" class=\"tree-image " + this._srcImage2 + "\" ";
  str += " onclick=\"webFXTreeHandler.all[this.parentNode.id].clickImage('"+this._action2+"')\"></span>";
  // fin insertar imagen
...
WebFX2ImageTreeItem.prototype.clickImage = function (nmbFuncion) {
