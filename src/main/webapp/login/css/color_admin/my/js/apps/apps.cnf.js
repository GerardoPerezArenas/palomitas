/*   
 ...
 < !-- === === == MY === === == -- >
 MY_1.data - toggle - class = "CLASS_NAME" Toggles the class with data - toggle - class value
 MY_1.1.data - toggle - class = "CLASS_NAME" Toggles the parent class with data - toggle - class - parent value
 * /
...
var handlePanelAction = function () {
    ...
    // reset form
    $('[data-click=panel-form-reset]').hover(function () {
        $(this).tooltip({
            title: 'Reset',
            placement: 'bottom',
            trigger: 'hover',
    ...
    $('[data-click=panel-form-reset]').click(function (e) {
        var target = $(this).closest('.panel');
        if (!$(target).hasClass('panel-loading')) {
            var targetBody = $(target).find('.panel-body');
            if (!targetBody.length) {
                console.log("No existe un .panel-body");
            }
            var spinnerHtml = '<div class="panel-loader"><span class="spinner-small"></span></div>';
            $(target).addClass('panel-loading');
            $(targetBody).prepend(spinnerHtml);
...
/* MY_1.data - toggle - class = "CLASS_NAME"
 ------------------------------------------------ */
$("[data-toggle-class]").on('click', function (e) {
    $(this).toggleClass($(this).attr("data-toggle-class"));
});
/* MY_1.1. data-toggle-class="CLASS_NAME"
 ------------------------------------------------ */
$("[data-toggle-class-parent]").on('click', function (e) {
    $(this).parent().toggleClass($(this).attr("data-toggle-class-parent"));
});
