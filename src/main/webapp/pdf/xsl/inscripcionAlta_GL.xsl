		...
		<xsl:template name="pagina">
			<xsl:param name="nh">1</xsl:param>
				...
				<table border="0" align="center" width="270mm"  cellpadding="0mm">
						...
						<td>
								...
								<tr>
									<td width="130mm" class="textoDiligencia">
										En virtude do disposto no artigo 70 do Regulamento de Poboación e Demarcación Territorial das Entidades Locais, na súa nova redacción dada polo Real Decreto 2612/96, do 20 de decembro, o/a/os veciños asinantes solicitan o alta no Padrón Municipal de Habitantes deste concello de <xsl:value-of select="datosAyto/concello"/>, así coma das outras persoas que se relacionan, das que ten/teñen representación.
									</td>
					...
					<tr>
						<td height="15mm">
							Sinatura de tódolos maiores de idade
						</td>
					</tr>
					<tr>
						<td height="4mm">
							Relación de persoas que se inscriben
						</td>
					</tr>
					<tr>
						<td height="11mm">
								...
								<tr>
									<td>
										...
										<tr>
											...
											<td width="11mm" class="textoFijo2" valign="middle">Tarx. Res.</td>
											<td width="4mm" class="textoFijo1" valign="left">
				...
				<xsl:template name="dAytoAlta">
					...
					<tr>
						<td class="textoFijo1">
							...
							<tr>
								<td width="13mm" class="textoFijo1">Enderezo: </td>
							...
							<tr>
								<td width="15mm" class="textoFijo1">Concello: </td>
								<td colspan="4" class="textoFijo1">
						...
						<table border="0" align="center" width="135mm" cellpadding="0">
							...
							<tr>
								<td colspan="2" height="32mm" class="textoDiligencia">
										Dilixencia: para facer constar que, por Resolución de Alcaldía a data  <xsl:value-of select="datosHabitante/habitante[position() = ($nh)]/fechaOperacion"/> foron dadas de alta e anotadas no Padrón como residentes neste concello, as persoas en número de 1 que figuran relacionadas neste documento.
								</td>
							</tr>
							<tr>
				...
				<table border="0" width="135mm" cellpadding="0">
					...
					<tr>
						<td colspan="3" height="10mm" class="textoDiligencia">
							Así mesmo declaran: que estaban(n) inscritos no Padrón Municipal de Habitantes do concello de <xsl:value-of select="datosHabitante/habitante[position() = ($nh)]/descMunicipioProcedencia"/>, provincia de <xsl:value-of select="datosHabitante/habitante[position() = ($nh)]/descProvinciaProcedencia"/>.
						</td>
					</tr>
				</table>
		</xsl:template>
