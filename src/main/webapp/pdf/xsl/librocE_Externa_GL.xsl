...
<xsl:template match="ROW"> 
	<tr style="color:black;"> 
  		<td width="255mm" align="left">
			...
			<table padding-bottom="0mm" class="colodd" width="255mm" align="center" cellborder="0mm" border-bottom="1px" border-left="1px" border-right="2px" border-top="1px">
	    		<tr> 
				...
				<tr>
                  ...
                  <xsl:otherwise>
              <table padding-bottom="0mm" class="colwhite" width="255mm" align="center" cellborder="0mm" border-bottom="1px" border-left="1px" border-right="2px" border-top="1px">
	    		<tr>
    	 			<td width="12mm" align="left"  padding-top="1mm">
						<xsl:choose>
							<xsl:when test="ESTADO&gt;'8'">
