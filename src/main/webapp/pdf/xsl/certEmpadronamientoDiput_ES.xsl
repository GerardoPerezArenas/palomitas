					...
					<tr>
                        <xsl:choose>
								<xsl:when test="tipoCertificado = 'individual'">
											<td class="textoDiligencia"><b>CERTIFICO:</b> Que en el Padrón Municipal de Habitantes de este municipio figura, en el día de la
								                fecha y en la hoja que se indica, la siguiente inscripcion:</td>
								</xsl:when>
								<xsl:otherwise>
                                            <td class="textoDiligencia"><b>CERTIFICO:</b> Que en el Padrón Municipal de Habitantes de este municipio figuran, en el día de la
				   ...
				   <tr><td height="2mm"></td></tr>
				    <tr>
						<td class="textoDiligencia">Y para que conste, y a los efectos oportunos,
								expido la presente certificación de orden y con el visto y plácet del Sr. Alcalde en <xsl:value-of select="ayto"/>, a <xsl:value-of select="fechaDocumento"/>.
						</td>
					</tr>
					<tr><td height="10mm"></td></tr>
					<tr>
