					...
					<tr>
                        	<xsl:choose>
								<xsl:when test="tipoCertificado = 'individual'">
						            <td class="textoDiligencia"><b>CERTIFICO:</b> Que no Padrón Municipal de Habitantes deste concello figura, no día da
								        data e na folla que se indica, a seguinte inscripcion:</td>
								</xsl:when>
								<xsl:otherwise>
									<td class="textoDiligencia"><b>CERTIFICO:</b> Que no Padrón Municipal de Habitantes deste concello figuran, no día da
								data e na folla que se indica, as seguintes inscripcions:</td>
				                </xsl:otherwise>
							</xsl:choose>
				   ...
				   <tr><td height="2mm"></td></tr>
				    <tr>
						<td class="textoDiligencia">E para que conste, e ós efectos oportunos,
								expido a presente certificación de orde e co visto e prace do Sr. Alcalde en <xsl:value-of select="ayto"/>, <xsl:value-of select="fechaDocumento"/>.
						</td>
					</tr>
					<tr><td height="10mm"></td></tr>
					<tr>
	...
	<xsl:template name="colectivo">		
		...
		<table border="0" align="center" width="175mm" height="10mm">
		  	...
		  	<tr>
		  		...
		  		<tr>
					<td colspan="4" height="6mm"><b>Número de personas que comprenden esta certificación: </b>
