							...
							<table cellborder="0" width="100%">
								...
								<tr>
									<td style="font-size:6;" colspan="4">
										Autorizamos ós maiores de idade empadroados nesta folla para comunicar ó Concello as futuras variacións dos nosos e obter
									</td>
								</tr>
								<tr>
									<td style="font-size:6;">
		...
		<xsl:template name="datosPie">
			...
			<tr>
				...
				<td width="60%" align="center" valign="top">
					Firma dos maiores de idade que se inscriben nesta folla
				</td>
				<td width="15%">
					<table cellborder="0" cellpadding="1" width="100%">
						<tr>
