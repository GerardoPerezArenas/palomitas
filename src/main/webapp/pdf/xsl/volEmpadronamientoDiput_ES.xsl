					...
					<tr>
                        <xsl:choose>
                            <xsl:when test="tipoCertificado = 'individual'">
                                <td class="textoDiligencia">En el Padrón Municipal de Habitantes de este municipio aparece, en el día de la
                                    fecha y en la hoja que se indica, la inscripcion cuyos datos se recogen en este volante:</td>
                            </xsl:when>
                            <xsl:otherwise>
                                <td class="textoDiligencia">En el Padrón Municipal de Habitantes de este municipio aparecen, en el día de la
								fecha y en la hoja que se indica, las inscripciones cuyos datos se recogen en este volante:</td>
                            </xsl:otherwise>
                        </xsl:choose>
		...
		<xsl:template name="pagina_3">
				...
				<table border="0" align="center" width="175mm" height="12mm">
				   ...
				   <tr><td height="2mm"></td></tr>
				    <tr>
						<td class="textoDiligencia">En <xsl:value-of select="ayto"/>, a <xsl:value-of select="fechaDocumento"/>.
						</td>
					</tr>
				    <tr>
						<td height="25mm" class="textoDiligencia" valign="bottom">El/La Funcionario/a</td>
					</tr>
				    <tr>
						<td height="5mm"></td>
					</tr>
					<tr>
						<td class="textoNota">NOTA: Este documento tiene carácter informativo en relación con la residencia y el domicilio habitual en este Municipio, de acuerdo con lo establecido en el artículo del R.D. 2612/1996, de 20 de deciembre por el que se modifica el Reglamento de Población y Demarcación Territorial de las Entidades Locales aprobado por R.D. 1690/1986, de 11 de junio.
