...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<xsl:template match="/LISTADO">
		   ...
		   <thead>
    			<tr>
    				<td width="275mm" class="titulo">CONSULTA DE REGISTROS DE INSTRUMENTOS DE PLANEAMIENTO</td>
    			</tr>
  			</thead>
			</table>
           ...
           <thead>
                <tr>
                    ...
                    <xsl:if test="//REGISTRO/PROCEDIMIENTO">
                        <td width="58mm" class="cabecera" style="border-right:solid black 1px;">Procedimiento</td>
                    </xsl:if>
                </tr>
              </thead>
               <tbody>
    ...
    <xsl:template match = "procedimiento" >
        <xsl:if test="( . != '')">
            <tr>
                ...
                <table width="275mm"  border="0" valign="top" align="center" cellpadding="0mm">
                <tr>
                <td width="28mm" class="etiqueta" >Procedimiento: </td>
                <td width="247mm" class="valor" ><xsl:value-of select="."/></td>
                </tr>
                </table>
                </td>
    ...
    <xsl:template match = "fechaVigencia" >
        <xsl:if test="( . != '')">
            <tr>
                ...
                <table width="275mm"  border="0" valign="top" align="center" cellpadding="0mm">
                <tr>
                <td width="28mm" class="etiqueta" >Fecha de Vigencia: </td>
                <td width="247mm" class="valor" ><xsl:value-of select="."/></td>
                </tr>
                </table>
                </td>
