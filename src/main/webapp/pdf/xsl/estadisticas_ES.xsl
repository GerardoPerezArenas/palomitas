...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="ESTADISTICA">
		<table width="175mm" height="15mm" padding="1" valign="top" align="center">
			<tr>
				<td class="titulo1" align="center" width="100%">INFORME ESTADÍSTICO DE DATOS PADRONALES</td>
			</tr>
		</table>
			...
			<tr>
				<td>
					<table width="175mm" padding="0" valign="middle" align="center">
						...
						<tr>
							<td class="etiqueta" width="20%">Nacionalidad:</td>
							<td colspan = "3" class="notaPeq" width="80%"><xsl:value-of select="NACION"/></td>
						</tr>						
						<tr >
							<td class="etiqueta" width="20%">F. Nacimiento:</td>
						...
						<tr >
							<td class="etiqueta" width="20%">F. Empadronamiento:</td>
