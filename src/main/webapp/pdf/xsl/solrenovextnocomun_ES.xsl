                ...
                <table align="center" width="200mm">
						...
						<td>
							<table width="200mm" border="0">
								<tr>
								    ...
								    MANIFIESTA que continua residiendo en este municipio y que, a efectos de dar
                                    cumplimiento a lo dispuesto en el artículo 16.1, 2º párrafo, de la Ley 7/1985,
                                    de 2 de abril, Reguladora de las Bases de Régimen Local, insta la renovación de su
					...
					<tr>
						<td>
							<table width="200mm">
								<tr>
									<td width="110mm">Ilmo. Sr. Alcalde del Ayuntamieto de  <xsl:value-of select="ayto"/></td>
								</tr>
							</table>
						</td>
					</tr>
                    ...
                    <tr>
                        <td>* Número de identificación de extranjero que conste en documento, en vigor, expedido
                        por las autoridades españolas</td>
                    </tr>
                </table>
