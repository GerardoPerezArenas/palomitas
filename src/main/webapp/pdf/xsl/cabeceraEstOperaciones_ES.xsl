    ...
    <table width="100%" border="0" cellborder="0" align="left">
      <tr>
        <td>
          <table width="100%" border="0" cellborder="0" align="left">
            <tr>
              <td class="titulos" width="65%">Ayuntamiento de <xsl:value-of select="municipio"/>
              </td>
            ...
            <tr>
              <td width="100%">
                <table width="100%" border="0" cellborder="0" cellpadding="0">
                   ...
                   <td height="6mm">
                      <table width="100%" border="0" cellpadding="0" class="cabecera">
                        <tr>
						  ...
						  <td width="44%" align="center" class="etiqueta-Superior-cabecera">BAJAS</td>
                  ...
                  <tr>
                   <td height="6mm">
                      <table width="100%" border="0" cellpadding="0" class="cabecera" height="10mm">
                        <tr>
						  <td width="7%" align="center" class="etiqueta-EsquinaSuperior-cabecera">Año</td>
                          <td width="9%" align="center" class="etiqueta-Superior-cabecera">Omisión</td>
						  <td width="9%" align="center" class="etiqueta-Superior-cabecera">Nacimiento</td>
                          ...
                          <td width="9%" align="center" class="etiqueta-Superior-cabecera">Duplicidad</td>
                          <td width="8%" align="center" class="etiqueta-Superior-cabecera">Total</td>
