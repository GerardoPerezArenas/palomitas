                ...
                <table align="center" width="200mm">
                    ...
                    <tr>
                        ...
                        <table border="1" align="center" width="200mm">
					        <tr>
                                <td align="center" valign="bottom">DATOS DE IDENTIFICACIÓN DO REPRESENTANTE</td>
                            </tr>
                        </table>
                        <table border="1" align="center" width="200mm">
                            <tr>
                                <td  class="textoFijo1_bi2" colspan="3"> NOME:</td>
                            </tr>
                            <tr>
                                <td  class="textoFijo1_bi2" width="100mm"> 1º APELIDO:</td>
                                <td  class="textoFijo1_bi2" width="100mm" colspan="2"> 2º APELIDO:</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td  class="textoFijo1_bi2" colspan="3"> DNI, Tarxeta de extranxeiro ou Pasaporte:</td>
                            </tr>
                        </table>
                        </td>
                    </tr>
						...
						<td>
							<table width="200mm" border="0">
								<tr>
								    ...
								    MANIFESTA:
                                    <p>1º Que ostenta a reprentación da persona arriba referenciada para cumplimientar o presente trámite, en virtude (**):
                                    ...
                                    <p>____________________________________________________________________________________________________________</p>
                                    <p>
                                    2º Que o meu representado continúa residindo habitualmente neste municipio e que, a
                                        efectos de dar cumprimento o disposto no artígo 16.1, 2º parágrafo, da
                                        Lei 7/1985, de 2 de abril, Reguladora das Bases de Réxime Local, insta
                                        a renovación da inscripción padronal;
                                    </p>
                                    </td>
								</tr>
							</table>
                    ...
                    <tr>
                        <td>
                            ...
                            <p>** Especificar documento acreditativo da representación conforme o apartado 5 da Resolucion</p>
                        </td>
                    </tr>
                </table>
