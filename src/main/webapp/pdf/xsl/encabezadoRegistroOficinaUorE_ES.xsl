					...
					<xsl:if test="IMG != ''"> <!-- Hay escudo -->				
						...
						<xsl:if test="ENT != ''"> <!-- Hay nombre -->
							...
							<td width="80mm" align="center" valign="middle">
								<table width="80mm" border="0" align="center">
								<tr>
								...
								<tr>
								    <td align="center" valign="middle">
		     							<h4>Oficina Origen: <xsl:value-of select="ORIGEN"/></h4>
									</td>
								</tr>
								</table>
							</td>
							<td width="125mm">
								<table width="125mm" border="0" align="center">
		   						<tr>
									...
									<tr>
										<td align="center" valign="middle">
		     							<h4>Oficina Destino: <xsl:value-of select="UOR"/></h4>
										</td>																			
									</tr>
		...
		<xsl:if test="OPC = 1">
	 		<table width="255mm" padding="1" border="1" cellborder="0" valign="middle" align="center">
				<tr>
					...
					<td width="75mm" align="left" style="font-family:Times;font-size:10;font-weight:bold;">
						REMITENTE
					</td>
					<td width="60mm" align="left" style="font-family:Times;font-size:10;font-weight:bold;">
						UNIDAD DESTINO
					</td>
				</tr>
			</table>
