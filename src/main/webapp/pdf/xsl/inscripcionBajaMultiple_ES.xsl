...
-->          
                    ...
                    <tr>
                      ...
                      <td colspan="2" class="textoDiligencia" align="left">
                        <xsl:choose>
                          <xsl:when test="titulo='BAJA POR CAMBIO DE RESIDENCIA'">
                          Declaración triplicada que, a efectos de lo dispuesto en el artículo 15 de la Ley Reguladora de Bases de Régimen Local 7/1995 de 2 de abril y de acuerdo con lo establecido en el art. 56 del Reglamento de Población y Demarcación Territorial de las Entidades Locales, los vecinos firmantes en número de 1 solicitan la baja en el Padrón Municipal de Habitantes en el ayuntamiento de	
                          <xsl:value-of select="datosPadron/descMunicipio"/>, 
                          Provincia de <xsl:value-of select="datosPadron/descProvincia"/>, por su traslado al Ayuntamiento de 						
					...
					<tr>
						<td height="4mm">
							Relación de persoas que se dan de baja
						</td>
					</tr>
					<tr>
						<td height="7mm">
...
-->					
				<tr>
					<td height="30mm">
						<xsl:choose>
						<xsl:when test="titulo='BAJA POR CAMBIO DE RESIDENCIA'  and datosHabitante/habitante[position() = 1]/codProvinciaDestino!= '' and datosHabitante/habitante[position() = 1]/codMunicipioDestino!= ''">
								...
								<tr>
									<td>
										...
										<tr>
											...
											<td width="11mm" class="textoFijo2" valign="middle">Tarx. Resid.</td>
											<td width="4mm" class="textoFijo1" valign="left">
			...
			<xsl:template name="datosAytoBaja">		
				...
				<tr>
					<td  height="15mm" class="textoDiligencia">
							Diligencia: queda anotada y registrada la baja en el Padrón, como residentes en este ayuntamiento, las personas a las que se refiere esta declaración y que figuran relacionadas en este documento.
					</td>
				</tr>
				<tr>
				...
				<table border="0" align="center" width="135mm" cellpadding="0">
					...
					<tr>
						<td colspan="2" height="16mm" class="textoDiligencia">
							Diligencia: para hacer constar que, por Resolución de el/la Alcalde/Alcaldesa la fecha <span class="subrayado">____</span>/<span class="subrayado">____</span>/<span class="subrayado">________</span> fueron dadas de alta en el Padrón como residentes en este ayuntamiento las personas en número de 1 que figuran en este documento.
						</td>
					</tr>
					<tr>
				...
				<table border="0" width="132mm" cellpadding="0">
					...
					<tr>
						<td height="5mm" class="textoDiligencia">
							IMPORTANTE: este documento deberá ser presentado por el interesado al solicitar el alta como residente en el  nuevo ayuntamiento dentro del plazo de 30 días contados a partir de la fecha en la que se le otorgase la baja en el ayuntamiento de procedencia.
						</td>
					</tr>
				</table>				
			</xsl:template>
