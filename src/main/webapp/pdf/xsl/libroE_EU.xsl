...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="ROWSET">
        <table cellpadding="0mm" padding-bottom="0mm" padding-left="0mm" padding-right="0mm" class="colwhite"
               width="255mm" border-bottom="0px" border-left="0px" border-right="0px" border-top="0px" align="center">
            <xsl:choose>
                <xsl:when test="ROW">
                    <xsl:apply-templates/>
                </xsl:when>
                ...
                <xsl:choose>
                    <xsl:when test="COLOR=1">
                        <table padding-bottom="0mm" class="colodd" width="255mm" align="center" cellborder="0"
                               border-bottom="1px" border-left="1px" border-right="2px" border-top="1px">
                            <tr>
