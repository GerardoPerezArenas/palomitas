		...
		<xsl:template name="df">
			...
			<xsl:template name="pagina">
				...
				<table border="0" align="center" width="200mm" height="12mm">
					<tr>
						<td class="cabecera1I" width="140mm" align = "center"><b>Padrón Municipal - <xsl:value-of select="concello"/> (<xsl:value-of select="provincia"/>)</b></td>
				...
				<table border="0" align="center" width="200mm">
					...
					<tr>
                        <xsl:choose>
                            ...
                            <td><b>CERTIFICO:</b> Que no Padrón Municipal deste concello figura, no día da
								data e na folla que se indica, a seguinte inscripción:</td>
                            </xsl:when>
                            <xsl:otherwise>
                                <td><b>CERTIFICO:</b> Que no Padrón Municipal deste concello figuran, no día da
								data e na folla que se indica, as seguintes inscripcións:</td>
                            </xsl:otherwise>
                        </xsl:choose>
					</tr>
					<tr><td height="2mm"></td></tr>
					<tr>
						<td valign="bottom">DATOS DO PADRÓN MUNICIPAL</td>
					</tr>
					<tr>
						<td>
							<table width="200mm">
								...
								<tr>
									...
									<td width="68mm" class="textoFijo1_bd">
										<table>
											<tr>
												<td height="3mm">Folla Padronal</td>
											</tr>
											<tr>
						...
						<td>
							<table width="200mm">
								...
								<tr>
									...
									<td width="20mm" class="textoFijo1_bd">
										<table>
											<tr>
												<td height="2mm">Porta</td>
											</tr>
											<tr>
                    ...
                    <tr>
						<td>
							<table width="200mm">
                                ...
                                <tr>
									<td class="textoFijo2">
                                        <xsl:value-of select="observaciones"/><br/>
                                        A presente certificación esta extendida en   <xsl:value-of select="$pg+1"/>  follas.
									</td>
								</tr>
							</table>
						</td>
				   ...
				   <tr>
					...
					<tr>
						<td class="textoDiligencia">E para que conste, e ós efectos que se indica,
								expido a presente certificación de orde e co visto e prace do Sr. Alcalde en <xsl:value-of select="ayto"/>, a <xsl:value-of select="fechaDocumentoTexto"/>.</td>
					</tr>
					<tr>
						<td height="1mm"></td>
					</tr>
					<tr>
						<td>
							<table width="180mm">
								...
								<tr>
									<td width="90mm"><xsl:value-of select="cargoAlcalde"/></td>
								
								</tr>
                                 <xsl:if test="tipoCertificado = 'individual'">
                                    <tr>
                                        <td height="20mm"></td>
                                    </tr>
                                </xsl:if>
                                <tr>
									<td width="90mm"> <xsl:value-of select="nombreAlcalde"/></td>
									</tr>
							</table>
						</td>
					</tr>
