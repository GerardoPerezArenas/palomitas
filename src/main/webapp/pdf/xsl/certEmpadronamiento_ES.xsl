		...
		<xsl:template name="df">
			...
			<xsl:template name="pagina">
				...
				<table border="0" align="center" width="200mm">
					...
					<tr><td height="1mm"></td></tr>
					<tr>
                        <xsl:choose>
								<xsl:when test="tipoCertificado = 'individual'">
                                    <td><b>CERTIFICO:</b> Que en el Padrón Municipal de este municipio figura, en el día de
                                            la fecha y en la hoja que se indica, la siguiente inscripcion:</td>
								</xsl:when>
								<xsl:otherwise>
                                    <td><b>CERTIFICO:</b> Que en el Padrón Municipal de este municipio figuran, en el día de
							...
							<table width="200mm">
                                ...
                                <tr>
                                    <td class="textoFijo2">
                                        ...
                                        La presente certificación esta extendida en <xsl:value-of select="$pg+1"/> hojas.
									</td>
								</tr>
							</table>
						</td>
				   ...
				   <tr>
					...
					<tr>
						<td class="textoDiligencia">Y para que conste, y a los efectos que se indica,
								expido la presente certificación de orde y con el visto y plácet del Sr. Alcalde en <xsl:value-of select="ayto2"/>, a <xsl:value-of select="fechaDocumentoTexto"/>.</td>
					</tr>
					<tr>
						<td height="2mm"></td>
					</tr>
					<tr>
						<td>
							<table width="180mm">
								<tr>
									<td colspan="2">VºBº</td>
								</tr>
								<tr>
									<td  width="180mm"><xsl:value-of select="cargoAlcalde"/></td>
								</tr>
                                ...
                                <tr>
									<td width="180mm">Fdo.:  <xsl:value-of select="nombreAlcalde"/></td>
								</tr>
							</table>
						</td>
					</tr>
