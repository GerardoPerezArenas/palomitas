			...
			<tr>
				...
				<td width="50%" >
					<table cellborder="0" cellpadding="0" width="100%">
						...
						<tr>
							<td width="100%" align="center" style="font-size:8;">
								Firma del director del establecimiento colectivo
							</td>
						</tr>
					</table>				
				</td>
	...
	<xsl:template name="reversoPagina">
		...
		<tr>
			<td width="100%" class="textoReverso">
				...
				<br/>- La hoja cumplimentada debe ser firmada por la persona que realiza el trámite, si su objeto es la corrección o actualización de datos. Cuando se trate de una nueva hoja de inscripción, firmarán todos los mayores de edad que se inscriban. Si se incorporan nuevos habitantes a una hoja existente, además deberá firmar la autorización de las nuevas inscripciones el director del establecimiento colectivo.
				...
				<br/>- Se utilizará un cuestionario de viviendas colectivas para cada hotel, pensión, fonda, parador, casa de huéspedes, residencia, hostal, albergue y similares, así como para establecimiento religioso, militar, sanitario, penitenciario, etc. en el que se encuentre, al menos una persona.
				<br/>- No obstante, si dentro de estos establecimientos colectivos existen viviendas de carácter familiar destinadas al personal directivo, administrativo o de servicios, las personas que en la fecha de referencia se encuentren en ellas se inscribirán aparte en una hoja de vivienda familiar.
				<br/><b>&nbsp;&nbsp;La presentación de esta hoja cumplimentada en su Ayuntamiento implica su conformidad para actualizar el Censo Electoral en consonancia con los datos reflejados en ella.
				</b>
			</td>
		</tr>
		<tr>
