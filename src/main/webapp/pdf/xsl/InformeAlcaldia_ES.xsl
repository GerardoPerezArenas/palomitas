					...
					<tr>
						<td>
							<xsl:choose>
 							...
 							<xsl:value-of select="nombreAlcalde"/>,  <xsl:value-of select="cargoAlcalde"/> PRESIDENTE DE ESTE AYUNTAMIENTO,
 						</td>
					</tr>
					<tr><td height="4mm"></td></tr>
					<tr>
						<td align="left"><b>INFORMO:</b> <br/> <br/> Que hechas las averiguaciones oportunas reside, de forma habitual, la/s siguiente/s persona/s en el domicilio que se indica a continuación: </td>
					</tr>
		...
		<xsl:template name="pagina_3">
				...
				<table border="0" align="center" width="175mm" height="12mm">				
				   ...
				   <tr><td height="2mm"></td></tr>					
				    <tr>
						<td class="textoDiligencia">Expido la presente, a petición del interesado y a los efectos oportunos, en  <xsl:value-of select="ayto"/>, a <xsl:value-of select="fechaDocumento"/>.
						</td>
					</tr>
					<tr><td height="10mm"></td></tr>
					<tr>
							...
							<table width="110mm">								
								<tr>
									<td height="20mm" align="center" width="110mm">								
									  ...
									  <xsl:value-of select="cargoAlcalde"/>
									 </td>
								</tr>
								</table>
						</td>
	...
	<xsl:template name="colectivo">		
		...
		<table border="0" align="center" width="175mm" height="10mm">
			  ...
			  <tr>
		  		...
		  		<tr>
					<td colspan="5" height="6mm"><b>Número de personas que comprende este informe: </b>
