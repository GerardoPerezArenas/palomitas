...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="ROW">
        <tr style="color:black;">
            <td width="255mm" align="left">
                ...
                <table padding-bottom="0mm" class="colodd" width="255mm" align="center" cellborder="0"
                       border-bottom="0px" border-left="1px" border-right="2px" border-top="1px">
                    <tr>
                    ...
                    <xsl:otherwise>
                           ...
                           <table padding-bottom="0mm" class="colwhite" width="255mm" align="center" cellborder="0"
                       border-bottom="0px" border-left="1px" border-right="2px" border-top="1px">
                    <tr>
                        <td width="12mm" align="left" padding-top="1mm">
                            <xsl:choose>
    ...
    <xsl:template match="ASUNTO">
        <td width="90mm" align="left" padding-top="1mm" padding-left="0mm" padding-right="15mm">
            <xsl:value-of select="."/>
        </td>
    </xsl:template>

    <xsl:template match="DESTINO">
        <td width="50mm" align="left" padding-top="1mm" padding-left="2mm" padding-right="6mm">
            <xsl:value-of select="."/>
        </td>
    </xsl:template>
