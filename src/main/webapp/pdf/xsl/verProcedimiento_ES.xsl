...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="pagina">
			...
			<tr>
				<td>
					<table border="0" align="center" width="180mm" height="3mm" cellpadding="0px">
						<tr>
							<td width="100%" class="cabecera" align="left"> PROCEDIMIENTO: <xsl:value-of select="nombre"/></td>
						</tr>
					</table>
				</td>
			</tr>
		...
		<table border="1px" align="center" width="200mm"  cellpadding="1mm">
			<tr>
				<td width="200mm" colspan="2" class="etiqueta" align="center"><u>Datos Generales</u></td>
			</tr>
			<tr>
				<td width="200mm" colspan="2" height="2mm"></td>
			</tr>
			<tr>
				<td width="40mm" class="etiqueta" align="left">Fecha Desde:</td>
				<td width="160mm" align="left"><xsl:value-of select="fechaDesde"/></td>
			</tr>
			<tr>
				<td width="40mm" class="etiqueta" align="left">Fecha Hasta:</td>
			...
			<tr>
				<td width="40mm" class="etiqueta" align="left">Tipo Procedimiento:</td>
				<td width="160mm" align="left"><xsl:value-of select="nombreTipoProcedimiento"/></td>
			</tr>
			<tr>
				<td width="40mm" class="etiqueta" align="left">Unidad de Inicio:</td>
		...
		<table border="1px" align="center" width="200mm"  cellpadding="1mm">
			<tr>
				<td width="200mm" colspan="2" class="etiqueta" align="left">Enlaces:</td>
			</tr>
			<tr>
	...
	<xsl:template match = "//procedimiento/tramite" > 		
		...
		<table border="1px" align="center" width="200mm"  cellpadding="1mm">
			...
			<tr>
				<td width="45mm" class="etiqueta" align="left">Plazo:</td>
				<td width="155mm" align="left"><xsl:value-of select="plazo"/></td>
			</tr>
			<tr>
				<td width="45mm" class="etiqueta" align="left">Unidad Inicio(Manual):</td>
				<td width="155mm" align="left"><xsl:value-of select="nombreUnidadInicio"/></td>
			</tr>
                        <tr>
				<td width="45mm" class="etiqueta" align="left">Unidad del trámite:</td>
		...
		<table border="1px" align="center" width="200mm"  cellpadding="1mm">
			<tr>
				<td width="200mm" colspan="2" class="etiqueta" align="left">Condiciones Entrada:</td>
			</tr>
			<tr>
				<td width="20mm" class="etiqueta" align="left"></td>
		...
		<table border="1px" align="center" width="200mm"  cellpadding="1mm">
		    <tr>
				<td width="200mm" colspan="3" class="etiqueta" align="left">Condiciones Salida<xsl:value-of select="tipoCond"/><xsl:value-of select="obligatorio"/></td>
			</tr>
		<xsl:choose>
		...
		<xsl:choose>
		  <xsl:when test="tipoCondFav = 'FinalizacionSI'">
			<tr>
				<td width="20mm" class="etiqueta" align="left"></td>
				<td width="180mm" colspan="2" align="left" class="etiqueta" >Favorable(Fin Expediente)</td>
			</tr>
		  </xsl:when>
		</xsl:choose>
		<xsl:choose>
		  <xsl:when test="tipoCondFav = 'TramiteSI'">
			<tr>
				<td width="20mm" class="etiqueta" align="left"></td>
				<td width="180mm" colspan="2" align="left" class="etiqueta" >Favorable(Lista de Trámites)<xsl:value-of select="obligatorioF"/></td>
			</tr>
			<tr>
				<td width="20mm" class="etiqueta" align="left"></td>
				<td width="20mm" class="etiqueta" align="left"></td>
		...
		<xsl:choose>
		  <xsl:when test="tipoCondDFav = 'FinalizacionNO'">
			<tr>
				<td width="20mm" class="etiqueta" align="left"></td>
				<td width="180mm" colspan="2" align="left" class="etiqueta" >Desfavorable(Fin Expediente)</td>
			</tr>
		  </xsl:when>
		</xsl:choose>
		<xsl:choose>
		  <xsl:when test="tipoCondDFav = 'TramiteNO'">
			<tr>
				<td width="20mm" class="etiqueta" align="left"></td>
				<td width="180mm" colspan="2" align="left" class="etiqueta" >Desfavorable(Lista de Trámites)<xsl:value-of select="obligatorioDF"/></td>
			</tr>
			<tr>
				<td width="20mm" class="etiqueta" align="left"></td>
				<td width="20mm" class="etiqueta" align="left"></td>
      ...
      <table align="center" width="110mm" height="3mm" cellpadding="1px" border="0px">
        <tr>
         <xsl:choose>
           ...
           <xsl:otherwise>
             <td width="110mm" >- <xsl:value-of select="descTramite"/> tiene que estar <xsl:value-of select="estTramite"/></td>
           </xsl:otherwise>
         </xsl:choose>
        </tr>
      </table>
