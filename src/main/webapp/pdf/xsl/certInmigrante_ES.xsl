		...
		<xsl:param name="nf"/>		
			...
			<xsl:template name="pagina_1">
				...
				<table border="0" align="center" width="175mm">
					...
					<tr><td height="3mm"></td></tr>
					<tr>
						<td class="textoDiligencia"><b>CERTIFICO:</b> Que en el Padrón Municipal de este municipio figuran, en el día de la
				...
				<table border="0" align="center" width="175mm" height="12mm">				
				    ...
				    <tr>
						<td class="textoDiligencia">Y para que conste, y a los efectos oportunos,
								expido la presente certificación en <xsl:value-of select="ayto"/>, a <xsl:value-of select="fechaDocumento"/>.
						</td>
					</tr>
		...
		<table width="175mm" border="0" cellpadding="0">						
			...
			<tr>
				<td width="175mm" border="0">
					<table width="175mm" border="1" cellborder="0px" cellpadding="2px" cellmargin="2px">						
						<tr>
							<td colspan="2" height="12mm" class="textoNota9 ">La persona inscrita aporta para acreditar su estancia en España con anterioridad al 8/8/2004, el/los documento/s marcado/s a continuación:</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td width="170mm" valign="top" class="textoNota9 "> Tarjeta de asistencia sanitaria de un servicio público de salud en la que conste la fecha del alta, o en su caso, certificación en la que conste la fecha de antigüedad del alta.</td>
						</tr>						
						<tr>
							<td>
								<table width="2mm" height="2mm" border="1px" cellborder-right="1px" cellborder-bottom="2px" cellpadding="0" cellmargin="0">						
							...
							<td width="170mm" valign="top" class="textoNota9 "> Copia de la solicitud de escolarización de menores, debidamente registrada.</td>
						</tr>															
						<tr>
							<td>
								<table width="2mm" height="2mm" border="1px" cellborder-right="1px" cellborder-bottom="2px" cellpadding="0" cellmargin="0">						
							...
							<td width="170mm" valign="top" class="textoNota9 "> Copia de la solicitud debidamente registrada, certificación del informe de los Servicios Sociales o notificación de la resolución de percepción de ayudas sociales.</td>
						</tr>								
						<tr>
							<td>
								<table width="2mm" height="2mm" border="1px" cellborder-right="1px" cellborder-bottom="2px" cellpadding="0" cellmargin="0">						
							...
							<td width="170mm" valign="top" class="textoNota9 "> Documento de alta laboral o certificación de la misma expedida por la Seguridad Social.</td>
						</tr>
						<tr>
							<td>
								<table width="2mm" height="2mm" border="1px" cellborder-right="1px" cellborder-bottom="2px" cellpadding="0" cellmargin="0">						
						...
						<tr>
							...
							<td width="170mm" valign="top" class="textoNota9 "> Notificación de Resoluciones derivadas de la Normativa de Extranjería emitidas por el Ministerio del Interior.</td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				<td width="175mm" border="0">
					<table width="175mm" border="1" cellborder="0px" cellpadding="2px" cellmargin="2px">						
						<tr>
							<td colspan="2" height="12mm" class="textoNota9 ">A efectos del proceso de normalización establecido por la Disposición Transitoria Tercera del Real Decreto 2392/2004.</td>
						</tr>
					</table>
				</td>
			</tr>			
