...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<xsl:template match="/LISTADO">
		   ...
		   <thead>
    			<tr>
    				<td width="275mm" class="titulo">CONSULTA DE REXISTROS DE CONVENIOS URBANÍSTICOS</td>
    			</tr>
  			</thead>
			</table>
           ...
           <thead>
                <tr>
                    ...
                    <xsl:if test="//REGISTRO/OBJETO_CONVENIO">
                        <td width="125mm" class="cabecera">Obxecto do convenio</td>
                    </xsl:if>
                    <xsl:choose>
    ...
    <xsl:template match = "objetoConvenio" >
        <xsl:if test="( . != '')">
            <tr>
                ...
                <table width="275mm"  border="0" valign="top" align="center" cellpadding="0mm">
                <tr>
                <td width="28mm" class="etiqueta" >Obxecto Convenio: </td>
                <td width="247mm" class="valor" ><xsl:value-of select="."/></td>
                </tr>
                </table>
                </td>
