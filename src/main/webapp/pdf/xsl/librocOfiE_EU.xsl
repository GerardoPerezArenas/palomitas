...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="ROWSET">
        <table cellpadding="0mm" padding-bottom="0mm" padding-left="0mm" padding-right="0mm" class="colwhite"
               width="255mm" border-bottom="2px" border-left="0px" border-right="0px" border-top="0px" align="center">
            <xsl:choose>
                <xsl:when test="ROW">
                    <xsl:apply-templates/>
                </xsl:when>
            ...
            <td width="255mm" align="left">
                ...
                <xsl:choose>
                    <xsl:when test="COLOR=1">
                        ...
                        <table padding-bottom="0mm" class="colodd" width="255mm" align="center"
                               cellborder="0mm" border-bottom="1px" border-left="1px" border-right="2px"
                               border-top="1px">
                            <tr>
                                ...
                                <td width="70mm" align="left" padding-right="15mm" padding-top="1mm">
								...
								<td width="45mm" align="left" padding-right="15mm" padding-top="1mm">
                                    <!-- Poner el primer apellido-->
                                    <xsl:choose>
                                        <xsl:when test="DESTINO=''"></xsl:when>
                                        <xsl:otherwise>
                                ...
                                <xsl:when test="ESTADO&gt;'8'">
                                    ...
                                    <tr style="color:black;">
                                        <td width="250mm" colspan="5">
                                            Deuseztatzeko eginbidea:
                                            <xsl:value-of select="DILIGENCIA"/>
                                        </td>
                                    </tr>
                                </xsl:when>
                    ...
                    <xsl:otherwise>
                        ...
                        <table padding-bottom="0mm" class="colwhite" width="255mm" align="center"
                               cellborder="0mm" border-bottom="1px" border-left="1px" border-right="2px"
                               border-top="1px">
                            <tr>
                                <td width="12mm" align="left" padding-top="1mm">
    ...
    <xsl:template match="ASUNTO">
        <td width="80mm" align="left" padding-top="1mm" padding-left="0mm" padding-right="15mm">
            <xsl:value-of select="."/>
        </td>
    </xsl:template>
            ...
            <xsl:when test="contains($str,$repl)">
                <xsl:call-template name="replace">
                    <xsl:with-param name="str"
                                    select="concat(substring-before($str,$repl),$target,substring-after($str,$repl))"/>
