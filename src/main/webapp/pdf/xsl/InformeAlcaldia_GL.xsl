				...
				<table border="0" align="center" width="175mm">
					...
					<tr>
						<td>
							...
							<xsl:value-of select="nombreAlcalde"/>,  <xsl:value-of select="cargoAlcalde"/> PRESIDENTE DESTE CONCELLO,
							</td>
					</tr>
					<tr><td height="4mm"></td></tr>
					<tr>
					<td align="left"><b>INFORMO:</b> <br/> <br/> 
						Que feitas as averiguacións oportunas reside, de xeito habitual, a/as seguinte/s persoa/s no enderezo que se indica a continuación:</td>
					</tr>
		...
		<xsl:template name="pagina_3">
				...
				<table border="0" align="center" width="175mm" height="12mm">				
				   ...
				   <tr><td height="2mm"></td></tr>					
				    <tr>
						<td class="textoDiligencia">Expido a presente, a petición do interesado e aos efectos oportunos,
								 en <xsl:value-of select="ayto"/>, <xsl:value-of select="fechaDocumento"/>.
						</td>
					</tr>
					<tr><td height="10mm"></td></tr>
					<tr>
						<td>
							<table width="110mm">
								...
								<tr>
									<td height="20mm" align="center" width="110mm">
											<xsl:choose>
										<xsl:when test="tratamientoAlcalde='Dª' or  tratamientoAlcalde='Dª.' 
											or tratamientoAlcalde='DNA' or  tratamientoAlcalde='DNA.' 
											or tratamientoAlcalde='DÑA' or tratamientoAlcalde='DÑA.'
			...
			<tr>
				...
				<td width="115mm" > 
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:value-of select="familia[position() = $nf]/datosHabitante/habitante[position()=1]/numeroDocumento"/><xsl:value-of select="familia[position() = $nf]/datosHabitante/habitante[position()=1]/letraDocumento"/>
							</xsl:otherwise>
						</xsl:choose>
				</td>
			</tr>
	...
	<xsl:template name="colectivo">		
		...
		<table border="0" align="center" width="175mm" height="10mm">
				...
				<tr>
					...
					<td width="65mm"  height="3mm">Nome e Apelidos</td>
					<td width="25mm"  align="center"  height="3mm">Sexo</td>
					<td width="35mm"  align="center"  height="3mm">Documento</td>
					<td width="40mm"  align="center"  height="3mm">Data Nacemento</td>
				</tr>
				<tr>
					<td width="15mm"  align="left"  height="3mm">Orde</td>
					<td width="65mm"  height="3mm">Lugar Nacemento</td>
					<td width="25mm"  align="center"  height="3mm"></td>
					<td width="35mm"  align="center"  height="3mm"></td>
					<td width="40mm"  align="center"  height="3mm">Nacionalidade</td>
				</tr>				
				<tr>
			  ...
			  <tr>
				...
				<tr>
		  		...
		  		<tr>
					<td colspan="5" height="6mm"><b>Número de persoas que abrangue este informe: </b>
