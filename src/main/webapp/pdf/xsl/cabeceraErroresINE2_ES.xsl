    ...
    <table width="100%" border="0" cellborder="0" align="left">
      <tr>
        <td>
          <table width="100%" border="0" cellborder="0" align="left">
            <tr>
              <td class="titulos" width="60%">Ayuntamiento de <xsl:value-of select="municipio"/>
              </td>
              ...
              <td class="titulos">
			  		<xsl:choose>
						<xsl:when test="nombreFichero!='null'">
							Nombre fichero:&nbsp;<xsl:value-of select="nombreFichero"/>	
						</xsl:when>
					</xsl:choose>
              </td>
              </tr>
                   ...
                   <td height="6mm">
                      <table width="100%" border="0" cellpadding="0" class="cabecera">
                        <tr>
						  ...
						  <td width="40%" align="center" class="etiqueta-Superior">Apellidos, nombre</td>
                          <td width="8%" align="center" class="etiqueta-Superior">Tipo</td>
                          <td width="10%" align="center" class="etiqueta-Superior">Fecha</td>
                          <td width="32%" align="center" class="etiqueta-Superior">Errores</td>
                        </tr>                        
                      </table>
                    </td>
                  </tr>
