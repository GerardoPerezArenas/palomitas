	...
	<xsl:template name="pagina">
				...
				<table border="0" align="center" width="175mm">
					...
					<tr>
                         <xsl:choose>
								...
								data e na folla que se indica, a inscripcion cos datos que se recollen neste volante:</td>
                                </xsl:when>
                                <xsl:otherwise>
                                    <td class="textoDiligencia">No Padrón Municipal de Habitantes deste municipio aparecen, no día da
                                    data e na folla que se indica, as inscripcions cos datos que se recollen neste volante:</td>
                                </xsl:otherwise>
				        </xsl:choose>
		...
		<xsl:template name="pagina_3">
				...
				<table border="0" align="center" width="175mm" height="12mm">
					...
					<tr>
						<td><b>Efecto para o que se expide:</b></td>
					</tr>
					<tr>
				   ...
				   <tr><td height="2mm"></td></tr>
				    <tr>
						<td class="textoDiligencia">En <xsl:value-of select="ayto"/>, <xsl:value-of select="fechaDocumento"/>.
						</td>
					</tr>
				    <tr>
						<td height="25mm" class="textoDiligencia" valign="bottom">O/A Funcionario/a</td>
					</tr>
				    <tr>
						<td height="5mm"></td>
					</tr>
					<tr>
						<td class="textoNota">NOTA: Este documento ten carácter informativo en relación coa residencia e o domicilio habitual neste Municipio, de acordo co establecido no artigo do R.D. 2612/1996, de 20 de decembro polo que se modifica o Regulamento de Poboación e Demarcación Territorial das Entidades Locais aprobado por R.D. 1690/1986, de 11 de xuño.
		...
		<table border="0" align="center" width="175mm" height="10mm">
				...
				<tr>
					...
					<td width="10mm"  height="4mm"></td>
                                ...
                                <tbody>
				<tr>
					<td class="textoNota9" width="10mm"  align="center"  height="3mm">Nº</td>
					<td class="textoNota9" width="75mm"  height="3mm">Nome e Apelidos</td>
					...
					<td class="textoNota9" width="40mm"  align="center"  height="3mm">Data Nacemento</td>
					<td class="textoNota9" width="10mm"  align="center"  height="3mm">Data</td>
				</tr>
				<tr>
					<td class="textoNota9" width="10mm"  align="left"  height="3mm">Orde</td>
					<td class="textoNota9" width="75mm"  height="3mm">Lugar Nacemento</td>
					<td class="textoNota9" width="10mm"  align="center"  height="3mm"></td>
					<td class="textoNota9" width="30mm"  align="center"  height="3mm"></td>
					<td class="textoNota9" width="40mm"  align="center"  height="3mm">Nacionalidade</td>
			  ...
			  <tr>
				...
				<tr>
					<td colspan="4" height="6mm"><b>Número de personas que comprende este volante: </b>
