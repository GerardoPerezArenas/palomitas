		...
		<xsl:template name="df">
			...
			<xsl:template name="pagina">
				...
				<table border="0" align="center" width="200mm" height="12mm">
					<tr>
						...
						<td class="cabecera1D" width="80mm" border="1"><p align="center">
                            <b>SOLICITUD DE RENOVACIÓN DE LA INSCRIPCIÓN PADRONAL PARA EXTRANJEROS NO COMUNITARIOS SIN
                                AUTORIZACIÓN DE RESIDENCIA PERMANENTE, PRESENTADA POR REPRESENTANTE
				...
				<table border="0" align="center" width="200mm">
					<tr>
						<td align="center" valign="bottom">DATOS DE IDENTIFICACIÓN DEL INTERESADO, SOLICITANTE DE LA RENOVACIÓN</td>
					</tr>
                </table>
                <table align="center" width="200mm">
                    ...
                    <tr>
                        ...
                        <table border="1" align="center" width="200mm">
					        <tr>
                                <td align="center" valign="bottom">DATOS DE IDENTIFICACIÓN DEL REPRESENTANTE</td>
                            </tr>
                        </table>
                        <table border="1" align="center" width="200mm">
                            <tr>
                            ...
                            <tr>
                                <td  class="textoFijo1_bi2" width="100mm"> 1º APELLIDO:</td>
                                <td  class="textoFijo1_bi2" width="100mm" colspan="2"> 2º APELLIDO:</td>
                            </tr>
                            <tr>
						...
						<td>
							<table width="200mm" border="0">
								<tr>
								    ...
								    MANIFIESTA:
                                    <p>1º Que ostenta la reprentación de la persona arriba referenciada para
                                    cumplimientar el presente trámite, en virtud de (**):____________________________________________________________________________________________________________</p>
                                    <p>____________________________________________________________________________________________________________</p>
                                    <p>____________________________________________________________________________________________________________</p>
                                    <p>
                                    2º Que mi representado continúa residiendo habitualmente en este municipio y que, a
                                        efectos de dar cumplimiento a lo dispuesto en el artículo 16.1, 2º párrafo, de
                                        la Ley 7/1985, de 2 de abril, Reguladora de las Bases de Régimen Local, insta
                                        la renovación de la inscripción padronal;
                                    </p>
                                    </td>
								</tr>
							</table>
                    ...
                    <tr>
                        <td>
                            <p>* Número de identificación de extranjero que conste, en vigor, expedido por las autoridades Españolas</p>
                            <p>** Especificar documento acreditativo de la representación conforme al apartado 5 de la Resolucion</p>
                        </td>
                    </tr>
                </table>
