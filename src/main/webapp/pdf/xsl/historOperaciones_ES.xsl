	...
	<xsl:template match="/historial">
		...
		<table width="255mm" padding="1" valign="top" align="center">
			<tr>				
				...
				<td border = "1" class="titulo" align="center" width="40%">HISTORIAL DE OPERACIONES</td>
				<td class="titulo" width="15%" align="right">F.E.&nbsp;<xsl:value-of select="fecEmpadronamiento"/></td>																
	  			...
	  			<td>
					<table width="255mm" padding="1" border="0" valign="middle" align="center">
						<tr>
							...
							<td class="etiqueta" width="15%">Fecha de la Operación</td>																
						</tr>
					</table>		  			
	  			</td>
	  		</tr>
				...
				<td>		
					<table width="255mm" padding="0" border="1" valign="middle" align="center">
						<tr>
							...
							<td class="etiqueta" width="15%">Apellido1</td>
							<td class="etiqueta" width="25%">Teléfono</td>
							<td class="etiqueta" width="15%">Fecha Nacimiento</td>
							<td class="etiqueta" width="30%">Domicilio</td>
							<td class="etiqueta" width="10%">Procedencia/Destino</td>			   
						</tr>
						<tr>
							<td class="etiqueta" width="5%">Sección</td>
							<td class="etiqueta" width="15%">Apellido2</td>
							<td class="etiqueta" width="25%">N.I.E.</td>
							<td class="etiqueta" width="15%">Provincia Nacimiento</td>
							<td class="etiqueta" width="30%">Entidad Singular</td>
							<td class="etiqueta" width="10%">Provincia</td>			   
						</tr>
						<tr>
							<td class="etiqueta" width="5%">Hoja</td>
							<td class="etiqueta" width="15%">Nombre</td>
							<td class="etiqueta" width="25%">Titulación</td>
							<td class="etiqueta" width="15%">Municipio Nacimiento</td>
							<td class="etiqueta" width="30%">Entidad Colectiva</td>
							<td class="etiqueta" width="10%">Municipio</td>			   
						</tr>
						<tr>
							<td class="etiqueta" width="5%">Orden</td>
							<td class="etiqueta" width="15%">N.I.F.</td>
							<td class="etiqueta" width="25%">Sexo</td>
							<td class="etiqueta" width="15%">Nacionalidad</td>
