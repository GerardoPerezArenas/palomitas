...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
        ...
        <table border="0" align="left">
          ...
          <tr>
            <td>
              <table border="0" align="left">
                <tr>
                  <td class="titulos" width="110mm">ATA <xsl:value-of select="hasta"/>
                  </td>
                </tr>
              </table>
            </td>
  ...
  <xsl:template name="cuerpo">
    <table border="0" align="left">
      ...
      <tr>
        <td class="etiqueta">Nome do ficheiro: <xsl:value-of select="nombreFichero"/></td>
      </tr>
      <tr>
        <td height="10px"></td>
      </tr>
      <tr>
        <td class="etiqueta">Total de rexistros: <xsl:value-of select="numeroRegistros"/></td>
      </tr>
      <tr>
        <td>
          <xsl:if test="tipo!=4">
            ...
            <table border="0">
              ...
              <tr>
                <td class="etiqueta">Baixas: <xsl:value-of select="numeroBajas"/></td>
              </tr>
              <tr>
                <td class="etiqueta">Modificacións: <xsl:value-of select="numeroModificaciones"/></td>
              </tr>
              <tr>
                <td class="etiqueta">Rexeitados: <xsl:value-of select="numeroRegistrosRechazados"/></td>
              </tr>
            </table>
            </blockquote>
          </xsl:if>
