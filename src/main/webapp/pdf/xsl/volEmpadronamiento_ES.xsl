			...
			<xsl:template name="pagina">
				...
				<tr>
					<xsl:choose>
                        ...
                        <td class="textoDiligencia" > En el Padrón Municipal de Habitantes de este municipio aparece, en el día de
							la fecha y en la hoja que se indica, la inscripcion cuyos datos se recogen en este volante:</td>
                        </xsl:when>
                        <xsl:otherwise>
                            <td class="textoDiligencia" > En el Padrón Municipal de Habitantes de este municipio aparecen, en el día de
							la fecha y en la hoja que se indica, las inscripciones cuyos datos se recogen en este volante:</td>
                        </xsl:otherwise>
				    </xsl:choose>
				</tr>
				<tr><td height="2mm"></td></tr>
				<tr>
					<td valign="bottom">DATOS DEL PADRÓN MUNICIPAL
				</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<table width="200mm" height="20mm">
							<tr>
								<td >
									NOTA: Este documento tiene carácter informativo en relación con la residencia y el domicilio habitual en este Municipio, de acuerdo con lo establecido en el artículo del R.D. 2612/1996, de 20 de diciembre por el que se modifica el Reglamento de Población y Demarcación Territorial de las Entidades Locales aprobado por R.D. 1690/1986, de 11 de junio.
								</td>
							</tr>
						</table>
					</td>
