...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<xsl:template match="/LISTADO">
		   ...
		   <thead>
    			<tr>
    				<td width="275mm" class="titulo">CONSULTA DE REGISTROS DE BIENES Y ESPACIOS CATALOGADOS</td>
    			</tr>
  			</thead>
			</table>
           ...
           <thead>
                <tr>
                    ...
                    <xsl:if test="//REGISTRO/DENOMINACION_BIEN">
                        <td width="180mm" class="cabecera">Denominación del Bien</td>
                    </xsl:if>
	...
	<xsl:template match = "denominacionBien" >
		<xsl:if test="( . != '')">
	    	<tr>
    			...
    			<tr>
				<td width="28mm" class="etiqueta" >Denominación del Bien: </td>
    ...
    <xsl:template match = "relacionBien" >
        <xsl:if test="( . != '')">
            <tr>
                ...
                <table width="275mm"  border="0" valign="top" align="center" cellpadding="0mm">
                <tr>
                <td width="28mm" class="etiqueta" >Relación del Bien: </td>
                <td width="247mm" class="valor" ><xsl:value-of select="."/></td>
                </tr>
                </table>
                </td>
