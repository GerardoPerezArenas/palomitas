...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template name="pagina">
        ...
        <table border="0" align="center" width="200mm"  cellpadding="2mm">
            <tr>
                <td width="180mm" class="titulo1" align="left">DATOS XERAIS</td>
            </tr>           
        </table>
        <table border="0px" align="center" width="200mm"  cellpadding="1mm">
            ...
            <tr>
                ...
                <td width="35mm" class="etiqueta" align="left">Procedimento:</td>
            ...
            <tr>
                <td width="15mm" class="etiqueta" align="left"></td>
                <td width="35mm" class="etiqueta" align="left">Data inicio:</td>
                <td width="150mm" align="left"><xsl:value-of select="fechaInicio"/></td>
            </tr>
            <tr>
                <td width="15mm" class="etiqueta" align="left"></td>
                <td width="35mm" class="etiqueta" align="left">Data fin:</td>
            ...
            <tr>
                <td width="15mm" class="etiqueta" align="left"></td>
                <td width="35mm" class="etiqueta" align="left">Unidade inicio:</td>
            ...
            <tr>
                <td width="15mm" class="etiqueta" align="left"></td>
                <td width="35mm" class="etiqueta" align="left">Observacións:</td>
 ...
 <xsl:if test="position()=1">
            <table border="0" align="center" width="200mm"  cellpadding="2mm">
                <tr>
                    <td width="180mm" class="titulo1" align="left">DATOS DO EXPEDIENTE</td>
                </tr>
                <tr><td width="100%" height="2mm"></td></tr>
            </table>
    ...
    <xsl:template match = "//procedimiento/tramite" > 		
        ...
        <table border="0px" align="center" width="200mm"  cellpadding="1mm">
            ...
            <tr>
                <td width="15mm" class="etiqueta" align="left"></td>
                <td width="35mm" class="etiqueta" align="left">Unidade:</td>
    ...
    <xsl:template match = "//procedimiento/registro" >
        <table border="0" align="center" width="200mm"  cellpadding="2mm">
            <tr>
                <td width="180mm" class="titulo1" align="left">REXISTRO</td>
            </tr>
            <tr><td width="100%" height="2mm"></td></tr>
        </table>
        <table border="0px" align="center" width="200mm"  cellpadding="1mm">
            ...
            <tr>
                <td width="15mm" class="etiqueta" align="left"></td>
                <td width="35mm" class="etiqueta" align="left">Exer./Num:</td>
            ...
            <tr>
                <td width="15mm" class="etiqueta" align="left"></td>
                <td width="35mm" class="etiqueta" align="left">Data:</td>
